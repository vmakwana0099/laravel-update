...
//        $returnHtml .= '<input type="hidden" id="vpsform' . $count . '" name="vpsform' . $count . '" value="' . $count . '"/>';
        ...
        if(!empty($category) && $category == 'dedicatedserver'){
        ...
        $buttonText = "Buy Now";
        if(!empty($category) && $category == 'vps'){ $buttonText = "Configure"; }
        $returnHtml .= "<button class='btn-primary' title='Buy Now'>".$buttonText."</button>";
        $returnHtml .= '</form>';
