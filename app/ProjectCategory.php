...
class ProjectCategory extends Model
{
    ...
    {
        $response = false;
        $response = $this->hasOne('App\Project', 'id', 'intCategoryId');
        return $response;
    }
    ...
    {
        $response = false;
        $response = $this->hasOne('App\ProjectCategory', 'id', 'intParentCategoryId');
        return $response;
    }
    ...
    {
        $response = false;
        $response = $this->belongsTo('App\ProjectCategory', 'intParentCategoryId', 'id');
        return $response;
    }
    ...
    {
        $response     = false;
        $moduleFields = ['id', 'varTitle', 'intAliasId', 'intParentCategoryId', 'intDisplayOrder', 'varMetaTitle', 'varMetaKeyword', 'varMetaDescription', 'chrPublish'];
    ...
    {
        $response     = false;
        $moduleFields = ['id', 'varTitle', 'intParentCategoryId', 'intDisplayOrder', 'varMetaTitle', 'varMetaKeyword', 'varMetaDescription', 'chrPublish'];
