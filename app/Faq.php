...
class Faq extends Model {
    ...
    public static function getRecords() {
        ...
        if (empty($response)) {
            $response = Self::Select(['id', 'varTitle', 'fkProductCategories', 'fkProduct', 'chrLandingPage', 'txtDescription', 'intDisplayOrder', 'chrPublish'])
                    ->deleted()
                    ->publish()
                    ->paginate(10);
    ...
    public static function getRecordList($filterArr = false) {
        $response = false;
        $moduleFields = ['id', 'varTitle', 'fkProductCategories', 'fkProduct', 'chrLandingPage', 'txtDescription', 'intDisplayOrder', 'chrPublish'];
