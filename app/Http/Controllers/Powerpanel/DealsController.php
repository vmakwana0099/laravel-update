...
//        $category = CategoryArrayBuilder::getArray($category);
        ...
        if (!is_numeric($id)) {
            ...
            $breadcrumb = $this->breadcrumb;
            $data = compact('deals', 'total', 'DealsCategory', 'breadcrumb', 'imageManager', 'videoManager', 'DealsType', 'ProductCategory');
        }
    ...
    public function handlePost(Request $request) {
        ...
        if ($validator->passes()) {
            ...
            $DealsArr['varProductFeatures'] = $data['varProductFeatures'];
