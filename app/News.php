...
class News extends Model {
    ...
    public static function getFrontList($filterArr = false, $page = 1) {
        $response = false;
        $moduleFields = ['id', 'varTitle', 'fkIntImgId', 'intAliasId', 'varShortDescription', 'txtDescription', 'dtDateTime', 'varExternalLink'];
    ...
    public static function getLatestList($id = false) {
        $response = false;
        $moduleFields = ['id', 'varTitle', 'txtDescription', 'fkIntImgId', 'intAliasId', 'dtDateTime'];
        $aliasFields = ['id', 'varAlias'];
    ...
    public static function getFrontDetail($id) {
        $response = false;
        $moduleFields = ['id', 'varTitle', 'fkIntImgId', 'intAliasId', 'txtDescription', 'dtDateTime','varShortDescription'];
        $aliasFields = ['id', 'varAlias'];
    ...
    public static function getFeaturedList($limit = 10) {
        ...
        if (empty($response)) {
            $moduleFields = ['varTitle', 'fkIntImgId', 'varShortDescription', 'txtDescription', 'intAliasId', 'dtDateTime', 'created_at'];
            $aliasFields = ['id', 'varAlias'];
            $response = Self::getFrontRecords($moduleFields, $aliasFields)
                    ->deleted()
                    ->publish()
