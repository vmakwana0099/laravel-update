...
use Carbon\Carbon;
class CreateCareersCategoryTable extends Migration {
	/**
	* Run the migrations.
	*
	* @return void
	*/
	public function up() {
		Schema::create('careers_category', function (Blueprint $table) {
			$table->engine = 'InnoDB';
...
$table->timestamp('updated_at')->default(DB::raw('CURRENT_TIMESTAMP'));
		...
		Schema::table('careers_category', function(Blueprint $table) {
