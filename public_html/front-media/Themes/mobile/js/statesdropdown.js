...
states['IN'] = ["Andhra Pradesh","Arunachal Pradesh","Assam","Bihar","Chhattisgarh","Delhi","Goa","Gujarat","Haryana","Himachal Pradesh","Jammu and Kashmir","Karnataka","Kerala","Madhya Pradesh","Maharashtra","Manipur","Meghalaya","Mizoram","Nagaland","Orissa","Punjab","Rajasthan","Sikkim","Tamil Nadu","Tripura","Uttar Pradesh","West Bengal","Andaman and Nicobar Islands","Chandigarh","Dadra and Nagar Haveli","Daman and Diu","Lakshadweep","Puducherry","end"];
...
function statechange() {
    ...
    if (states[country]) {
        ...
        $("#stateinput").parent().append('<select name="state" style="margin-bottom:10px;" class="year-selection" id="stateselect"'+statesTab+'><option value="">-- Select State --</option>'+stateops+'</select>');
    } else {
        $("#stateselect").remove();
        $("#stateinput").show();
