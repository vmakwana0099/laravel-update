(function(e,t,n,r){
    ...
    n(t).ready(function(){
        n(".img-box").hover(function(){
            n(this).addClass("alt")
            },function(){
            n(this).removeClass("alt")
            })
        });
    n.extend(u,{
        version:"2.1.5",
...
jumpto:function(e,t,n){
    ...
    //console.log("direction : " + u.direction + " e =" + e + " index :" + i.index);  
    u.router=n||"jumpto";
    if(i.loop){
        if(e<0){
...
getViewport:function(){
    var t=u.current&&u.current.locked||false,n={
        x:s.scrollLeft(),
        y:s.scrollTop()
        };
...
_afterLoad:function(){
    var e=u.coming,t=u.current,r="fancybox-placeholder",i,s,o,a,f,l;
    u.hideLoading();
...
zoomIn:function(){
    var e=u.current,t=e.pos,r=e.openEffect,i=r==="elastic",s=n.extend({
        opacity:1
    },t);
    delete s.position;
    if(i){
...
zoomOut:function(){
    var e=u.current,t=e.closeEffect,n=t==="elastic",r={
        opacity:.1
    };
...
changeIn:function(){
    var e=u.current,t=e.nextEffect,n=e.pos,r={
        opacity:1
    },i=u.direction,s=200,o;
    n.opacity=.1;
    if(t==="elastic"){
...
changeOut:function(){
    var e=u.previous,t=e.prevEffect,r={
        opacity:.1
    },i=u.direction,s=200;
    if(t==="elastic"){
