...
/* Google Font API S */
    WebFontConfig = {
            google:{families:['Poppins:100,200,300,400,500,600,700,800', 'Open+Sans:400,500,600']}
        };
        (function() {
...
$(document).ready(function(){
    // Buorg
	var ie = (function() { if (new RegExp("MSIE ([0-9]{1,}[\.0-9]{0,})").exec(navigator.userAgent) != null) { return parseFloat( RegExp.$1 ); } else { return false; } })();
	if (ie && ie == 10) {
...
var left_arrow = '<i class="arrow_icon" title="Previous"><svg width="27" height="35" aria-hidden="true" data-prefix="fal" data-icon="angle-left" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512" class="fa-angle"><path fill="currentColor" d="M25.1 247.5l117.8-116c4.7-4.7 12.3-4.7 17 0l7.1 7.1c4.7 4.7 4.7 12.3 0 17L64.7 256l102.2 100.4c4.7 4.7 4.7 12.3 0 17l-7.1 7.1c-4.7 4.7-12.3 4.7-17 0L25 264.5c-4.6-4.7-4.6-12.3.1-17z" class=""></path></svg></i>';
var right_arrow = '<i class="arrow_icon" title="Next"><svg width="30" height="35" aria-hidden="true" data-prefix="fal" data-icon="angle-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512" class="fa-angle"><path fill="currentColor" d="M166.9 264.5l-117.8 116c-4.7 4.7-12.3 4.7-17 0l-7.1-7.1c-4.7-4.7-4.7-12.3 0-17L127.3 256 25.1 155.6c-4.7-4.7-4.7-12.3 0-17l7.1-7.1c4.7-4.7 12.3-4.7 17 0l117.8 116c4.6 4.7 4.6 12.3-.1 17z" class=""></path></svg></i>';
var left_arrow1 = '<i class="arrow_icon" title="Previous"><svg width="100%" height="100%" viewBox="0 0 30 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;"><g transform="matrix(1,0,0,1,0.0143932,0.00807261)">    <g id="Shape-25-copy" serif:id="Shape 25 copy" transform="matrix(1,0,0,1,-683.44,-1831.75)"><path d="M689.343,1844.56C689.59,1844.83 690,1844.83 690.255,1844.56C690.503,1844.31 690.503,1843.89 690.255,1843.64L685.626,1838.91L711.814,1838.91C712.17,1838.91 712.454,1838.62 712.454,1838.25C712.454,1837.89 712.17,1837.59 711.814,1837.59L685.626,1837.59L690.255,1832.87C690.503,1832.61 690.503,1832.19 690.255,1831.94C690,1831.68 689.59,1831.68 689.343,1831.94L683.617,1837.79C683.362,1838.04 683.362,1838.46 683.617,1838.71L689.343,1844.56Z" style="fill:rgb(153,153,153);fill-rule:nonzero;"/></g></g></svg></i>';
var right_arrow1 = '<i class="arrow_icon" title="Next"><svg version="1.1" id="Layer_1" xmlns:serif="http://www.serif.com/" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" height="100%"	 viewBox="0 0 400 400" enable-background="new 0 0 400 400" xml:space="preserve"><g transform="matrix(1,0,0,1,0.0143932,0.00807261)"><g id="Shape-25-copy" transform="matrix(1,0,0,1,-683.44,-1831.75)" serif:id="Shape 25 copy"><path fill="#999999" d="M996.573,1941.149c-3.293-3.6-8.76-3.6-12.159,0c-3.307,3.332-3.307,8.934,0,12.266l61.72,63.066H696.96c-4.746,0-8.532,3.867-8.532,8.801c0,4.801,3.786,8.801,8.532,8.801h349.174l-61.72,62.934c-3.307,3.467-3.307,9.066,0,12.4c3.399,3.465,8.866,3.465,12.159,0l76.347-78.002c3.4-3.332,3.4-8.932,0-12.266L996.573,1941.149z"/></g></g></svg></i>';
$(".testomonial-section .owl-carousel").owlCarousel({
	autoplay:4000,
...
$(".business_section .owl-carousel").on('initialized.owl.carousel change.owl.carousel changed.owl.carousel translated.owl.carousel', function(e) {
	  idx = e.item.index;
	  $('.owl-item.center').removeClass('center'); 
	  $('.owl-item').eq(idx-1).removeClass('center');
	  $('.owl-item').eq(idx+1).addClass('center');
	  $('.owl-item.for-z-index').removeClass('for-z-index'); 
	  $('.owl-item').eq(idx-2).removeClass('center');
	  $('.owl-item').eq(idx+2).addClass('for-z-index');
}).owlCarousel({
	autoplay:true,
	...
	nav:true,
	loop:true,
	navText: [left_arrow1, right_arrow1],
	items : 4,
		responsive:{
		0:{
			items:1
...
var left_arrow2 = '<i class="arrow_icon" title="Previous"><svg width="40" height="45" aria-hidden="true" data-prefix="fal" data-icon="angle-left" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512" class="fa-angle"><path fill="currentColor" d="M25.1 247.5l117.8-116c4.7-4.7 12.3-4.7 17 0l7.1 7.1c4.7 4.7 4.7 12.3 0 17L64.7 256l102.2 100.4c4.7 4.7 4.7 12.3 0 17l-7.1 7.1c-4.7 4.7-12.3 4.7-17 0L25 264.5c-4.6-4.7-4.6-12.3.1-17z" class=""></path></svg></i>';
var right_arrow2 = '<i class="arrow_icon" title="Next"><svg width="40" height="45" aria-hidden="true" data-prefix="fal" data-icon="angle-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512" class="fa-angle"><path fill="currentColor" d="M166.9 264.5l-117.8 116c-4.7 4.7-12.3 4.7-17 0l-7.1-7.1c-4.7-4.7-4.7-12.3 0-17L127.3 256 25.1 155.6c-4.7-4.7-4.7-12.3 0-17l7.1-7.1c4.7-4.7 12.3-4.7 17 0l117.8 116c4.6 4.7 4.6 12.3-.1 17z" class=""></path></svg></i>';
$(".review .owl-carousel").owlCarousel({
	...
	loop:true,
	dots: false,
	navText: [left_arrow2, right_arrow2],
	items : 3,
		responsive:{
		0:{
			items:1,
...
if($(window).width() > 1024){
	$('.navbar-header .dropdown').hover(function(){
	$(this).addClass('show');
	}, function() {
	$(this).removeClass('show');
	});
	
	/*megamenu active class in li script*/
	$('.megamenu .dropdown').hover(function(){
	$(this).addClass('active');
	$(this).siblings().removeClass('active');
	});
}
$('.navbar-header .nav-toggle').click(function(){
	$('#menu').slideToggle();
});
$('.nav-toggle').click(function(){
	$(this).toggleClass('nav-transform');
	$(".navbar-header .dropdown").removeClass('show-div');
	$(".plus-icon").removeClass('la-minus');
	$(".plus-icon").addClass('la-plus');
});
$('.plus-icon').on('click', function(){
    $(this).parent().siblings().removeClass('show-div');
    $(this).parent().siblings().children('.plus-icon').removeClass('la-minus');
    $(this).parent().siblings().children('.plus-icon').addClass('la-plus');
	$(this).toggleClass('la-plus');
	$(this).parent().toggleClass('show-div');
	$(this).toggleClass('la-minus');
});
$('.deals-share').click(function(){
	$(this).parent().find(".banner-social").toggleClass('social-sharing-show');
});
$('#load_more_home').click(function(){
		$(".services_section").toggleClass("show-more")
});
$('#load_more_home1').click(function(){
		$(".domain-search").toggleClass("show-more")
});
$(".scrollToTop").hide();
...
$(".white-overlay1 .overlay_link").click(
function(){
	var thumbHolder = $(".main-plan");
	thumbHolder.animate({scrollLeft: thumbHolder.scrollLeft() + 90},500) 
});
var lastScrollTop = 0;
  $(window).scroll(function(event) {
    ...
    if (st > lastScrollTop) {
      // downscroll code
      $(".mainheader").removeClass('is-visible').addClass('is-not-visible');
      $(".banner-wrapper").removeClass('not-modify').addClass('modify');
      $('body').addClass('modify');
    } else {
      // upscroll code
      $(".mainheader").removeClass('is-not-visible').addClass('is-visible');
      
    }
    if(st <= 0) {
      $('body').removeClass('modify');
      $("mainheader").removeClass('is-not-visible').addClass('is-visible');
      $(".banner-wrapper").removeClass('modify');
    }
    lastScrollTop = st;
 });
$(document).on('touchstart', function (e) {
 ...
 if (!container.is(e.target) && container.has(e.target).length === 0) 
    {
       $('.navbar').slideUp();
    $('.nav-toggle').removeClass('nav-transform');
    }
});
/*Login Popup*/
$('#loginModal').on('shown.bs.modal', function (e) {
	$('.loginPopup .owl-carousel').owlCarousel({
		loop:true,
		margin:10,
		nav:true,
		responsive:{
...
$('.features-start-mob .owl-carousel').owlCarousel({
    margin:10,
    nav:false,
	loop:true,
	items : 3,
...
// domain landing page carousel
$('.transfer-domain .owl-carousel').owlCarousel({
	autoplay:4000,
	autoplayTimeout:7000,
	autoplayHoverPause:false,
	autoplaySpeed:1500,
	...
	nav:true,
	loop:true,
	navText: ['<div class="sprite-image pre" title="Previous"></div>', '<div class="sprite-image next" title="Next"></div>'],
	items : 9,
    responsive:{
        0:{
            items:3,
...
// domain landing page carousel for extension domain showcase
$('.extension-slider .owl-carousel').owlCarousel({
    autoplay:4000,
    autoplayTimeout:7000,
    autoplayHoverPause:false,
    autoplaySpeed:1500,
...
$('.plan-text-slider .owl-carousel').owlCarousel({
    items:1,
    loop:true,
    margin:0,
    autoplay:true,
...
$('.Hits_advantages .owl-carousel').owlCarousel({
    autoplay:false,
	autoplayTimeout:7000,
	autoplayHoverPause:false,
	autoplaySpeed:1500,
...
$('.howtotransfer_div .owl-carousel').owlCarousel({
    autoplay:false,
	autoplayTimeout:7000,
	autoplayHoverPause:false,
	autoplaySpeed:1500,
...
// Show hide password onclick signin
...
AOS.refresh(true);
/*accodrdition multiple open Landing*/
  $('#accordion  h4').click(function() {
	  $(this).toggleClass("active-accordition");
      $(this).next().slideToggle();
      return false;
  });
  $(".sharing-icon").click(function(){
        $(this).parent().toggleClass("show");
    });	
var $root = $('html, body');
$('a.Click-to-Bottom').click(function () {
	$root.animate({scrollTop: $($(this).attr('href')).offset().top - 40}, 900);
	return false;
});
$('.more-features').click(function () {
	$(this).parent().find(".slide-toggle").slideToggle();
	$(this).toggleClass("minus-icon");
	$('.more-features span').text("More");
	$('.more-features.minus-icon span').text("Less");
});
$('.tooltip-link').tooltip({trigger: 'manual'});
...
$('#loc1').click(function(){
		$("#dedicated-plan1").addClass("india-active");
		$("#dedicated-plan2").removeClass("usa-active");
		$("#dedicated-plan3").removeClass("usa-active");
		$("#dedicated-plan4").removeClass("usa-active");
		$("#loc2, #loc3, #loc4").removeClass("active-tab");
		$(this).addClass("active-tab");
});
$('#loc2').click(function(){
		$("#dedicated-plan2").addClass("usa-active");
		$("#dedicated-plan1").removeClass("india-active");
		$("#dedicated-plan3").removeClass("usa-active");
		$("#dedicated-plan4").removeClass("usa-active");
		$("#loc1, #loc3, #loc4").removeClass("active-tab");
		$(this).addClass("active-tab");
});
$('#loc3').click(function(){
		$("#dedicated-plan3").addClass("usa-active");
		$("#dedicated-plan1").removeClass("india-active");
		$("#dedicated-plan2").removeClass("usa-active");
		$("#dedicated-plan4").removeClass("usa-active");
		$("#loc1, #loc2, #loc4").removeClass("active-tab");
		$(this).addClass("active-tab");
});
$('#loc4').click(function(){
		$("#dedicated-plan4").addClass("usa-active");
		$("#dedicated-plan1").removeClass("india-active");
		$("#dedicated-plan2").removeClass("usa-active");
		$("#dedicated-plan3").removeClass("usa-active");
		$("#loc1, #loc2, #loc3").removeClass("active-tab");
		$(this).addClass("active-tab");
});
$('#checked_tlds').click(function(){ 
	if($('#checked_tlds').hasClass('tlds_show')){
		$('#checked_tlds').removeClass('tlds_show');
		$('#checked_tlds span').text('Show Tlds');
		$("#checked_tlds").attr("title","Show Tlds");
		$('.bulksearch_tabing').hide();
		$('#checked_tlds i.fa').removeClass('fa-chevron-up');
		$('#checked_tlds i.fa').addClass('fa-chevron-down');
	}else{
		$('#checked_tlds').addClass('tlds_show');
		$('.bulksearch_tabing').show();
		$('#checked_tlds span').text('Hide Tlds');
		$("#checked_tlds").attr("title","Hide Tlds");
		$('#checked_tlds i.fa').removeClass('fa-chevron-down');
		$('#checked_tlds i.fa').addClass('fa-chevron-up');
	}
})
...
/*jQuery Bootstrap Responsive Tabs v2.0.1 */
...
$('.plan_section .responsive-tabs').responsiveTabs({
  accordionOn: ['xs', 'sm']
});	
}
if($(window).width() <= 767){ 
$('.chart-main-div .responsive-tabs').responsiveTabs({
  accordionOn: ['xs', 'sm']
});
}
if($(window).width() <= 767){ 
$('.vps-plan-main-div .responsive-tabs').responsiveTabs({
  accordionOn: ['xs', 'sm']
});
}
if($(window).width() >= 767){
...
/*add dollar icon*/
$('.rupees_ico,.rupees,.rupees_sign,.price-icon,.ruppess,.tld_rupees_ico,.rupee-icon').addClass('dollar-sign');
// for tooltip
$(document).ready(function(){
	//tooltip function
	...
	$('.header_section .navbar-header .dropdown-toggle').click(function() {
...
var deadline = new Date(Date.parse(new Date()) + 05 * 24 * 60 * 60 * 1000);
initializeClock('clockdiv', deadline);
// clock timer end
/*ios version detect*/
if(platform.product && platform.product == "iPad"){
    var strhtml1 = '<div style="font-size:18px;color:#fff;background:#18b35c;padding:15px;text-align:center;height:60px;z-index:9999;position:fixed;width:100%;top:0;margin:auto;">For a better experience on <strong style="color:#000;">Host IT Smart,</strong><a href="https://support.apple.com/downloads" style="cursor:pointer;color: #ffffff;font-size:14px;margin-left:10px;display:inline-block;" target="_blank">update your IOS Version.</a></div>';
    var strhtml2 = '<div style="font-size:18px;color:#fff;background:#18b35c;padding:15px;text-align:center;height:60px;z-index:9999;position:fixed;width:100%;top:0;margin:auto;">For a better experience on <strong style="color:#000;">Host IT Smart,</strong><a href="https://support.apple.com/downloads" style="cursor:pointer;color: #115baa;font-size:16px;margin-left:10px;display:inline-block;" target="_blank">update your browser.</a></div>';

    var iosvar = platform.os.toString().replace("iOS","");
    if(iosvar < 9){
        //alert('ipad with < 9' + platform.version);
        $("#browsernote").html(strhtml1).show();
    }
    if(platform.name == 'Safari' && platform.version < 9){
        //alert('ios with < 9' + platform.version);
        $("#browsernote").html(strhtml2).show();
    }  
}
/*remove animation except some sections*/
$(document).ready(function() {
    $("*").not( ".banner_section, .searchdomain_div, .logo, .navbar-header, .login_part, .cart_div, .currency_div" ).removeAttr("data-aos");
    $("*").not( ".banner_section, .searchdomain_div, .navbar-header, .login_part, .cart_div, .currency_div" ).removeAttr("data-aos-delay");
    $("*").removeAttr("data-aos-easing");
    $("*").removeAttr("data-aos-duration");
    $("*").not( ".banner_section, .searchdomain_div, .logo, .navbar-header, .login_part, .cart_div, .currency_div" ).removeClass("aos-init");
    $("*").not( ".banner_section, .searchdomain_div, .logo, .navbar-header, .login_part, .cart_div, .currency_div" ).removeClass("aos-animate");
});