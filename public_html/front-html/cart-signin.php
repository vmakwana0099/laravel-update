					 ...
					 <div class="row">
						<div class="col-sm-6 col-12">
						   <div class="signin">
							  ...
							  <button class="btn" title="Sign in" data-toggle="modal" data-target="#loginModal">Sign in</button>
						   </div>
						</div>
						<div class="col-sm-6 col-12">
						   <div class="signin signup">
							  <h3 class="signin-head">New to HostITSmart?</h3>
							  <span class="signin-text">Create an account now.</span>
							  <button class="btn" title="Create Account" data-toggle="modal" data-target="#loginModal">Create Account</button>
						   </div>
						</div>
					 </div>
				  </div>
