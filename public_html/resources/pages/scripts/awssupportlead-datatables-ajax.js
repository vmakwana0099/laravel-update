        ...
        grid.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [
                    ...
                    {"data": 1, className: 'text-left', "name": 'varFirstName'},
                    {"data": 2, className: 'text-left', "name": 'varLastName'},
                    ...
                    {"data": 7, className: 'text-center', "bSortable": false},
                    {"data": 8, className: 'text-center', "name": 'created_at'},
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/aws-support-leads/get_list", // ajax source
                },
                "order": [
                    [8, "desc"]
                    ...
                    if (exportRadioVal == 'selected_records') {
                        if ($('#ExportRecord').click) {
                            if ($('input[name="delete[]"]:checked').val()) {
                                ...
                                var ajaxurl = window.site_url + "/powerpanel/aws-support-leads/ExportRecord" + ip;
                        ...
                        var ajaxurl = window.site_url + "/powerpanel/aws-support-leads/ExportRecord";
                        window.location = ajaxurl;
                    }
                }
            }
