 ...
 function update_data(id) {
   ...
   var videoId = $('.video_' + id).val();

   $.ajax({
     type: "POST",
     cache: true,
     url: window.site_url + '/powerpanel/video-gallery/update',
     data: {
       'title': title,
       'id': id,
       'order': order,
 ...
 function update_status(id) {
   ...
   $.ajax({
     type: "POST",
     cache: true,
     url: window.site_url + '/powerpanel/video-gallery/update_status',
     data: {
       'id': id,
       'status': status
     },
 ...
 function remove(id) {
   ...
   if (response) {
     $.ajax({
       type: "POST",
       cache: true,
       url: window.site_url + '/powerpanel/video-gallery/destroy',
       data: {
         'id': id
       },
       success: function(data) {
