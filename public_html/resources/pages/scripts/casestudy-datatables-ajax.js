        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [{
                    ...
                    "ajax": {
                        "url": window.site_url + "/powerpanel/casestudy/get_list", // ajax source
                    },
...
function reorder(curOrder, excOrder) {
    var ajaxurl = site_url + '/powerpanel/casestudy/reorder';
    $.ajax({
        url: ajaxurl,
        data: {
            order: curOrder,
...
function makeFeatured(fid, status) {
    var ajaxurl = site_url + '/powerpanel/casestudy/makeFeatured';
    $.ajax({
        url: ajaxurl,
