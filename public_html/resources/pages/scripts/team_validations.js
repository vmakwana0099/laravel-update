		...
		var handleTeam = function() {
				 $("#frmTeam").validate({
					...
					messages: {
						...
						tag_line: Lang.get('validation.required', { attribute: Lang.get('template.designation') }),
						email: Lang.get('validation.required', { attribute: Lang.get('template.email') }),
						phone_no:{ 
							required:Lang.get('validation.required', { attribute: Lang.get('template.phone') }),
