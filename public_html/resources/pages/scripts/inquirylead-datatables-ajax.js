	...
	var handleRecords = function () {
        ...
        "stateSave": true, // save datatable state(pagination, sort, etc) in cookie.
				...
				"columns": [
					...
					{"data": 2, className: 'text-left',"name":'varDomain'},
					...
					{"data": 6, className: 'text-center',"name":'varIP'},
					{"data": 7, className: 'text-center',"name":'datetime'}
				],
				"ajax": {
					"url": window.site_url+"/powerpanel/inquiry-leads/get_list", // ajax source
				},
				"order": [
					[7, "desc"]
					...
					if (exportRadioVal == 'selected_records') {
						if ($('#ExportRecord').click) {
							if ($('input[name="delete[]"]:checked').val()) {
								...
								var ajaxurl = window.site_url+"/powerpanel/inquiry-leads/ExportRecord"+ip;
						...
						var ajaxurl = window.site_url+"/powerpanel/inquiry-leads/ExportRecord";
						window.location = ajaxurl;
					}
				}
			}
