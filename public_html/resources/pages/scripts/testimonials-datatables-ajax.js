        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [{
                    ...
                    "ajax": {
                        "url": window.site_url + "/powerpanel/testimonials/get_list", // ajax source
                    },
...
function reorder(curOrder, excOrder) {
    var ajaxurl = site_url + '/powerpanel/testimonials/reorder';
    $.ajax({
        url: ajaxurl,
        data: {
            order: curOrder,
...
function makeFeatured(fid, status) {
    var ajaxurl = site_url + '/powerpanel/testimonials/makeFeatured';
    $.ajax({
        url: ajaxurl,
