	...
	var handleRecords = function () {
        ...
        "stateSave": true, // save datatable state(pagination, sort, etc) in cookie.
				...
				"columns": [
					...
					{"data": 3, className: 'text-left',"name":'varPhoneNo'},
					{"data": 4, className: 'text-center',"bSortable":false},
					{"data": 5, className: 'text-center',"bSortable":false},
					{"data": 6, className: 'text-center',"name":'NoOfLicenses'},
					{"data": 7, className: 'text-center',"name":'varCompanyName'},
					{"data": 8, className: 'text-center',"name":'created_at'},
				],
				"ajax": {
					"url": window.site_url+"/powerpanel/google-contact-us/get_list", // ajax source
				},
				"order": [
					[7, "desc"]
					...
					if (exportRadioVal == 'selected_records') {
						if ($('#ExportRecord').click) {
							if ($('input[name="delete[]"]:checked').val()) {
								...
								var ajaxurl = window.site_url+"/powerpanel/google-contact-us/ExportRecord"+ip;
						...
						var ajaxurl = window.site_url+"/powerpanel/google-contact-us/ExportRecord";
						window.location = ajaxurl;
					}
				}
			}
