	...
	if (length>=3) {
		$.ajax({
			...
			success: function(data) {
		        ...
		        html += '<div class="team_box box_border nopadding">';
		        ...
		        html += '<a href="'+site_url+'/team/'+value.alias+'/details" class="btn btn_size btn_radius btn_bg_none btn_txt_change btn_bg_change" title="'+value.name+'"><i class="fa fa-link"></i></a>';	
		        html += '</div>';
		        html += '</div>';        		
		        html += '</div>';
		        html += '</div>';
		        html += '</div>';    		
		        html +=	'<div class="team_desc">';
		        html += '<h3><a href="'+site_url+'/team/'+value.alias+'/details" title="'+value.name+'" class="link">'+value.name+'</a></h3>';
...
function getPosts(page) {
  $.ajax({
    url : site_url+'/pagination/team?page='+page,
  }).done(function (data) {
	  $('.page').html(data);
