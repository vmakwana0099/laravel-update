...
var Validate = function() {
    var handleServiceCategory = function() {
        $("#frmRestaurantMenuCategory").validate({
            ...
            invalidHandler: function(event, validator) { //display error alert on form submit
                ...
                $('.alert-danger', $('#frmRestaurantMenuCategory')).show();
            },
        ...
        $('#frmRestaurantMenuCategory input').keypress(function(e) {
            if (e.which == 13) {
                if ($('#frmRestaurantMenuCategory').validate().form()) {
                    $('#frmRestaurantMenuCategory').submit(); //form validation success, call ajax form submit
                }
                return false;
            }
        });
