			...
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"columns": [
						...
						{"data": 2, className:'text-center',"name":'varEmail'},
						...
						{"data": 5, className:'text-center',"name":'dtDateTime'},
						{"data": 6, className:'text-center',"bSortable":false }
					],
					"ajax": {
						"url": window.site_url+"/powerpanel/restaurant-reservations/get_list", // ajax source
					}
					, "order": [
						[5, "desc"]
					],
						...
						if (exportRadioVal == 'selected_records') {
							if ($('#ExportRecord').click) {
								if ($('input[name="delete[]"]:checked').val()) {
									...
									var ajaxurl = window.site_url+"/powerpanel/restaurant-reservations/ExportRecord"+ip;
							...
							var ajaxurl = window.site_url+"/powerpanel/restaurant-reservations/ExportRecord";
							window.location = ajaxurl;
						}
					}
				}
