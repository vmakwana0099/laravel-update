...
if (st > lastScrollTop) {
  ...
  $('body').addClass('modify');
	...
	$('.domanilist-banner').addClass('sticky_domainlist');
	$(".domanilist-banner").css('top', $(".mainheader").height() + "px");
} else {
  // upscroll code
...
if(st <= 0) {
  ...
  $('.domanilist-banner').removeClass('sticky_domainlist');
  $('.domanilist-banner').css('top','0px !important');
  $('.domanilist-banner').removeAttr('style');
...
/*For continue to checkout section sticky at bottom*/
$(window).scroll(function (event) {
    var wrapper = $('#wrapper').height();
    var footer = $('.footer-start').height();
    var support = $('.cart-about').height();
    var windowheight = $(window).height();
    var totalfooter = footer + support;
    var ww = wrapper - windowheight;
    var main_height = ww - totalfooter;

    $(window).scrollEnd(function(){

	    if ($(this).scrollTop() < main_height) {
	        $(".secure-payment-info").addClass('fixed');
	    } else {
	        $(".secure-payment-info").removeClass('fixed');
	    }
	}, 100);
});
