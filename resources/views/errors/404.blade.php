                ...
                <div class="col-md-12">
                    <div class="text-center error-main">
                        ...
                        <div class="error-content aos-init" data-aos="fade-up" data-aos-delay="500">
                            <p>The Page requested not found.</p>
                            <p>You might have entered wrong URL or having spelling mistake in the URL address.</p><a class="btn" href="{{url('/')}}" title="Back to home">Back to Home</a></div>
                    </div>
                </div>
            </div>
        </div>
