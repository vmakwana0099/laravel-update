...
@if(!empty($Testimonials) && count((array)$Testimonials) >0)
...
<div class="banner-inner" style="background-image:url('{{ URL::to('/') }}/assets/images/domain_search/banner-bg-hosting.jpg');">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="d-md-flex d-none d-md-block justify-content-start mr-auto">
                ...
                <ul class="breadcrumb-style2 align-self-center">
                    ...
                    <li><a href="{{url('/')}}" title="Home"><i class="fa-solid fa-house"></i></a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    ...
                    @php
                        ...
                        if(isset($Testimonials->video['youtubeId']) && !empty($Testimonials->video['youtubeId']))

                        {

                            $videoId=$Testimonials->video['youtubeId'];
                    ...
                    @endphp
                            ...
                            <img alt="{{$Testimonials->varTitle}}" title="{{$Testimonials->varTitle}}" src="{{$imgthumnail}}" alt="{{$Testimonials->varTitle}}">
                    ...
                    @endphp    
                            ...
                            <img alt="{{$Testimonials->varTitle}}" title="{{$Testimonials->varTitle}}" src="{!! App\Helpers\resize_image::resize($Testimonials->fkIntImgId,600,600) !!}" alt="{{$Testimonials->varTitle}}">
                    ...
                    if(isset($Testimonials->video['varVideoName']) && !empty($Testimonials->video['varVideoName']) && empty($Testimonials->video['youtubeId'])){

                    @endphp

                        <div class="review-video-main__item__play">

                            <a data-fancybox="images" data-caption="" data-src="{{ url('/') }}/assets/videos/{{ $Testimonials->video['varVideoName'] }}.{{ $Testimonials->video['varVideoExtension'] }}" title="Play"><i class="fa fa-play-circle" aria-hidden="true"></i></a>
                    ...
                    elseif(isset($Testimonials->video['youtubeId']) && !empty($Testimonials->video['youtubeId']))
                    ...
                    @endphp
                        ...
                        <div class="review-video-main__item__play">
                            ...
                            <a data-fancybox="images" data-caption="" data-src="https://www.youtube.com/watch?v={{$Testimonials->video['youtubeId']}}" title="Play"><i class="fa fa-play-circle" aria-hidden="true"></i></a>
                            ...
                            <div class="share-news">
                                ...
                                <div class="socialshare">
                                    ...
                                    <ul class="banner-social">
                                        ...
                                        <li><a href="{{ $tw }}" target="_blank" class="share-social twitter" title="Twitter"><i class="fa-brands fa-x-twitter"></i></a></li>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="news_info aos-init" data-aos="fade-left">
                        ...
                        <div class="info">
                            ...
                            @if (isset($Testimonials->txtClientUrl) && !empty($Testimonials->txtClientUrl))

                                @php

                                    $clientSiteLink = explode(".",$Testimonials->txtClientUrl)

                                @endphp

                                @if (isset($clientSiteLink[1]) && !empty($clientSiteLink[1]) && isset($clientSiteLink[2]) && !empty($clientSiteLink[2]))

                                    <a class="uw-link" rel="nofollow" target="_blank" href="{{ $Testimonials->txtClientUrl }}"><i class="fa-solid fa-link"></i> {{$clientSiteLink[1].'.'.str_replace('/','',$clientSiteLink[2])}}</a> <br>
                            ...
                            @php 
                                ...
                                if(!empty($Testimonials->txtDescription)) {

                            @endphp

                            {!! $Testimonials->txtDescription !!}

                            @php  }else{  @endphp

                                {{ nl2br($Testimonials->txtShortDescription) }}
