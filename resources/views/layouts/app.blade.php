...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
     ...
     @if($live_url == $baseUrl . "/servers")
         @php $live_url = $baseUrl . "/servers/"; @endphp
     @endif

     @if(Request::segment(1) == 'web-hosting-ahmedabad')
         <link rel="canonical" href="{{ $baseUrl . '/web-hosting' }}" />
         <link rel="alternate" href="{{ $baseUrl . '/web-hosting-ahmedabad' }}" hreflang="en-in" />
         <link rel="canonical" href="{{ $baseUrl . '/web-hosting-ahmedabad' }}" />
     @endif
...
<script src="../assets/css/bootstrap/4.6.2/bootstrap.bundle.min.js" ></script>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.min.js" ></script>
@endif
@if(Request::segment(2)=='vps-hosting' || Request::segment(2)=='managed-vps-hosting' || Request::segment(2)=='linux-vps-hosting')
...
@endif
<script src="{{ asset('assets/js/vendors/magnific-popup.min.js?v=202311040647') }}"></script>
<script src="{{ asset('assets/js/vendors/hs.megamenu.js?v=202311040647') }}"></script>
<script src="{{ asset('assets/js/vendors/jquery.rcounterup.js?v=202311040647') }}"></script>
<script src="{{ asset('assets/js/vendors/owl.carousel.min.js?v=202311031254') }}"></script>
          ...
          <div class="modal-dialog modal-dialog-centered">
           <div class="modal-content">
            <div class="modal-header">
             <button type="button" class="close close-popup" id="close-cartfull-popup" data-dismiss="modal"></button>
...
<!-- S vk script 29_9_2002 check terms -->
      ...
      <script src="{{url('/')}}/assets/js/common_v12.js" type="text/javascript"></script>
      <script>
