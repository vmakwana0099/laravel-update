    ...
    <div class="vps-plan-main-div head-tb-p-40" id="web_hosting_plan">
        <div class="container">
            <div class="section-heading">
                <h2 class="text_head text-center">Choose & Buy Your Web Hosting Package in Ahmedabad</h2>
            </div>
            <div class="row">
                <div class="col-12">
                    <br />
...
<section class="hs-platform head-tb-p-40">
    <div class="hs-platform-bg">
        <div class="container">
            <div class="section-heading">
                <h2 class="text_head text-center">Explore Web Hosting Solutions Tailored for Every <br> Platform and Purpose</h2>
            </div>
...
<section class="wh-server-location head-tb-p-40">
    <div class="container">
        <div class="section-heading">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="section-heading">
                    ...
                    <p>Align with Host IT Smart’s web hosting services in Ahmedabad to experience blazing website speed that accelerates your online presence & bid farewell to boredom and slow loading times. Thanks to our top-notch infrastructure, which has helped millions of businesses deliver seamless user experiences, boosted their website's efficiency, empowered their online presence, and created brand credibility that is par excellence.</p>
...
<div class="modal fade more_feature" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content more_feature_modal">
            ...
            <div class="">
                <div title="Close" class="more-features-close-icon" data-dismiss="modal">x</div>
