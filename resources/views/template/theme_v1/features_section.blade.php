<div class="feature-section ptb-60">
    <div class="container">
        <div class="row justify-content-center pb-20">
            <div class="col-md-12 col-lg-12">
                <div class="section-heading text-center">
                    <h2 class="text_head">The 3 Pillars of a Great Hosting Service</h2>
                </div>
            </div>
        </div>
        <div class="row align-items-center justify-content-between">
            <div class="col-md-5 col-lg-6 d-none d-md-block d-lg-block">
                <div class="feature-img-wrap text-center">
                    <img src="{{url('/assets/images/Homepage/Quality_hardware.webp')}}" class="img-fluid" loading="lazy" alt="High-Quality Hardware">
                </div>
            </div>
        ...
        <div class="row align-items-center justify-content-between mt-5">
            ...
            <div class="col-md-5 col-lg-6 d-none d-md-block d-lg-block">
                <div class="feature-img-wrap text-center">
                    <img src="{{url('/assets/images/Homepage/Robust_hosting.webp')}}" class="img-fluid" loading="lazy" alt="Robust Systems for Hosting">
                </div>
            </div>
        </div>
        <div class="row align-items-center justify-content-between mt-5">
            <div class="col-md-5 col-lg-6 d-none d-md-block d-lg-block">
                <div class="feature-img-wrap text-center">
                    <img src="{{url('/assets/images/Homepage/Experience_lightning.webp')}}" class="img-fluid" loading="lazy" alt="Fast Connectivity & Low Latency">
                </div>
            </div>
            <div class="col-md-7 col-lg-6">
                <div class="hstng-content-wrap">
...
<section class="wm-dt-section head-tb-p-40">
    <div class="domain-hosting-place-top">
    </div>
    <div class="container">
        <div class="domain-hosting-place-center">
            <div class="row justify-content-center pb-20">
                <div class="col-md-12">
                    <div class="section-heading text-center my-4">
                        <h2 class="text_head_lgt">Easily Manage your Domain and Hosting <br>All in one place!</h2>
                    </div>
                </div>
            </div>
            <div class="domain-hosting-place-bottom">
                <div class="row align-items-center justify-content-between text-center">
                    <div class="col-lg-6 wmdts-res p-4 domain-transfer">
                        ...
                        <div class="action-btns mt-4">
                            <a href="{{ url('/domain/domain-transfer') }}" class="btn btn-brand-03" title="Get Started Now">Get Started Now</a>
                        </div>
                    </div>
                    <div class="col-lg-6 wmdts-res p-4">
                        <div class="cta-content-wrap">
                            <div class="mig-tra-image">
                        ...
                        <div class="action-btns mt-4">
                            <a href="{{ url('/web-hosting') }}" class="btn btn-brand-03" title="Get Started Now">Get Started Now</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="promo-section head-tb-p-40 ">
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-12">
                <div class="section-heading text-center">
                    <h2 class="text_head">Functionally Fast, Financially Fluid, Fabulously Fortified!</h2>
                    {{-- <p class="lead">Uniquely repurpose strategic core competencies with progressive content. Assertively transition ethical imperatives and collaborative manufactured products.</p> --}}
                </div>
            </div>
            <div class="col-lg-12">
                <div class="row justify-content-md-center justify-content-sm-center">
                    <div class="col-md-6 col-lg-4 cstmd-flex">
                        <div class="card single-promo-card single-promo-hover p-2 mt-4">
                            <div class="card-body">
                                <div class="pb-2">
                                    <span class="top-faeture ">
                                        <img  loading="lazy" src="../assets/images/Homepage/features-1.webp" alt="Promising Performance">
                                    </span>
                                </div>
                                <div class="pt-2 pb-3">
                    ...
                    <div class="col-md-6 col-lg-4 cstmd-flex">
                        <div class="card single-promo-card single-promo-hover p-2 mt-4">
                            <div class="card-body">
                                <div class="pb-2">
                                    <span class="top-faeture">
                                        <img  loading="lazy" src="../assets/images/Homepage/features-2.webp" alt="Flexible Options">
                                    </span>
                                </div>
                                <div class="pt-2 pb-3">
                    ...
                    <div class="col-md-6 col-lg-4 cstmd-flex">
                        <div class="card single-promo-card single-promo-hover p-2 mt-4">
                            <div class="card-body">
                                <div class="pb-2">
                                    <span class="top-faeture  ">
                                        <img  loading="lazy" src="../assets/images/Homepage/features-3.webp" alt="Incredibly Inexpensive">
                                    </span>
                                </div>
                                <div class="pt-2 pb-3">
                    ...
                    <div class="col-md-6 col-lg-4 cstmd-flex">
                        <div class="card single-promo-card single-promo-hover p-2 mt-4">
                            <div class="card-body">
                                <div class="pb-2">
                                    <span class="top-faeture  ">
                                        <img  loading="lazy" src="../assets/images/Homepage/features-4.webp" alt="Strong Security">
                                    </span>
                                </div>
                                <div class="pt-2 pb-3">
                    ...
                    <div class="col-md-6 col-lg-4 cstmd-flex">
                        <div class="card single-promo-card single-promo-hover p-2 mt-4">
                            <div class="card-body">
                                <div class="pb-2">
                                    <span class="top-faeture ">
                                        <img  loading="lazy" src="../assets/images/Homepage/features-5.webp" alt="Quality Assurance">
                                    </span>
                                </div>
                                <div class="pt-2 pb-3">
                    ...
                    <div class="col-md-6 col-lg-4 cstmd-flex">
                        <div class="card single-promo-card single-promo-hover p-2 mt-4">
                            <div class="card-body">
                                <div class="pb-2">
                                    <span class="top-faeture  ">
                                        <img  loading="lazy" src="../assets/images/Homepage/features-6.webp" alt="Everpresent Support">
                                    </span>
                                </div>
                                <div class="pt-2 pb-3">
...
<section class="promo-section head-tb-p-40 gray-light-bg">
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-10 col-lg-10">
                <div class="section-heading text-center mb-5">
                    <h2 class="text_head">Hosting Features For You</h2>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="row justify-content-md-center justify-content-sm-center">
...
<section class="contact_section head-tb-p-40">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6 col-lg-5 d-none d-lg-block">
                    <div class="ctact-img-wrap text-center">
                        <img  loading="lazy" src="{{url('/')}}/assets/images/Homepage/Support_img.webp" class="img-fluid" alt="server room">
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="ctact-content-wrap ">
                        <h2 class="text_head">We are always available to support you - 24X7/365!</h2>
                        <p>Let us help you realize your website dream. Give us a Call or Chat with us!</p>
                    </div>
                    <div class="support-action d-inline-flex flex-wrap">
                        <a id="email_contact_home_page" href="mailto:{{ App\Helpers\MyLibrary::encrypt_decrypt('decrypt',$contactData->varEmail) }}" title="{{ App\Helpers\MyLibrary::encrypt_decrypt('decrypt',$contactData->varEmail) }}" class="mr-3"><i class="fas fa-comment mr-1 color-accent"></i> <span>{{ App\Helpers\MyLibrary::encrypt_decrypt('decrypt',$contactData->varEmail) }}</span></a>
                        <a id="phone_number_home_page" href="tel:{{ App\Helpers\MyLibrary::encrypt_decrypt('decrypt',$contactData->varPhoneNo) }}" class="mb-0"><i class="fas fa-phone-alt mr-1 color-accent"></i> <span>{{ App\Helpers\MyLibrary::encrypt_decrypt('decrypt',$contactData->varPhoneNo) }}</span></a>
                    </div>
                </div>
            </div>
        </div>
