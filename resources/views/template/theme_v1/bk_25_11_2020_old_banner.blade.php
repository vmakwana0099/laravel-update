...
<div class="carousel-item {{$Banner_Active}} {{ $slider_class }} {{ $diwaliClass }}" <?php echo $mobilespecificbanner; ?>>
			...
			@elseif($bannerImg->varBannerVersion == "vid_banner")
					@if($uagent == "mobile")
						@if(strtolower($udevice) != "ipad")
							...
							{{-- Dwali static html code Start --}}
							@if ($index == 0)
	                        	<div class="row">
									<div class="col-sm-6 col-12">
										<div class="banner_image_one">
											<picture>
					                            <!-- <source media="(max-width: 767px)" srcset="../assets/images/black-friday-for-mobile.gif"> -->
					                            <!-- <source media="(max-width: 768px)" srcset="{{ $bannerImg->dasktopSourceUrl }}"> -->
					                            <img src="../assets/images/01-HomePage-Desktop-Banner-(BlackFriday)-offer.gif" alt="{{$bannerImg->dasktopSourceUrl}}" title="{{ $bannerImg->varTagLine }}" />
					                        </picture>
				                        </div>
									</div>
									<div class="col-sm-6 col-12">
							...
							<picture>
								...
								<img src="../assets/images/Offer-Animation.gif" alt="{{ $bannerImg->varTagLine }}" title="{{ $bannerImg->varTagLine }}" />
							</picture>
						...
						@else
                            ...
                            @if($ext == "jpg" || $ext == "png" || $ext == "jpeg" || $ext == "gif" )
                                ...
                                <picture>
                                    <!-- <source media="(max-width: 767px)" srcset="{{Config::get('Constant.CDNURL')}}/assets/images/homebanners/Diwali-Offer-2020/HomePage-Desktop-Banner2-Diwali-Offer-2020.gif">
                                    <source media="(max-width: 768px)" srcset="{{Config::get('Constant.CDNURL')}}/assets/images/homebanners/Diwali-Offer-2020/HomePage-Desktop-Banner2-Diwali-Offer-2020.gif"> -->
                                    <img src="../assets/images/Offer-Animation.gif" alt="{{$bannerImg->ipadSourceUrl}}" title="{{ $bannerImg->varTagLine }}" />
                                </picture>
					...
					@else
						...
						@if($_ext == "jpg" || $_ext == "png" || $_ext == "jpeg" || $_ext == "gif" )
	                        ...
	                        <picture>
	                            <!-- <source media="(max-width: 767px)" srcset="{{Config::get('Constant.CDNURL')}}/assets/images/homebanners/Diwali-Offer-2020/HomePage-Desktop-Banner2-Diwali-Offer-2020.gif">
	                            <source media="(max-width: 768px)" srcset="{{Config::get('Constant.CDNURL')}}/assets/images/homebanners/Diwali-Offer-2020/HomePage-Desktop-Banner2-Diwali-Offer-2020.gif"> -->
	                            <img src="../assets/images/Offer-Animation.gif" title="{{ $bannerImg->varTagLine }}" />
	                        </picture>
