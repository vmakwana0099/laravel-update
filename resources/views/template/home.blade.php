...
<div class="services_section">
    <div class="container">
        <h1 class="service-main-title col-12 aos-init"  data-aos="fade-up">
        ...
        <div class="row row flex-sm-row-reverse flex-row-reverse flex-row">
            <div class="col-lg-5 col-sm-12 col-12">
                <div class="support-text1">
                    ...
                    <a target="_blank" title="Submit Ticket" href="<?php echo $apiUrl; ?>/submitticket.php" class="btn aos-init" data-aos="fade-up" data-aos-delay="200" title="Submit Ticket">Submit Ticket</a>
                </div>
            </div>
