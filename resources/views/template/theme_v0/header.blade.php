{{-- <header class="header_section"> remove from here to move in app.blade.php --}}
                    ...
                    <img src="{{Config::get('Constant.CDNURL')}}/assets/images/rating1.png" alt="Rating">
                            ...
                            <div class="menu-links-responsive d-block d-xl-none row">
                                ...
                                <ul class="col-6">
                                    ...
                                    <li><a href="{{url('/manage')}}" target="_blank" title="My Account">My Account</a></li> <li><a href="{{url('/manage/index.php?rp=/cart/domain/renew')}}" title="My Renewals">My Renewals</a></li> @else <li><a href="" data-toggle="modal" data-target="#loginModal" title="Create Account">Create Account</a></li> @endif <li><a href="{{url("contact")}}" title="Contact Us">Contact Us</a></li>
                                </ul>
...
<ul>
<li><a href="https://www.hostitsmart.com/manage/clientarea.php"><i class="fa fa-user" ></i> My Profile</a></li>
<li><a href="https://www.hostitsmart.com/manage/clientarea.php?action=invoices"><i class="fa fa-file-text-o" ></i> Invoices</a></li>
<li><a href="https://www.hostitsmart.com/manage/clientarea.php?action=services"><i class="fa fa-cogs" ></i> Products/Services</a></li>
<li><a href="https://www.hostitsmart.com/manage/clientarea.php?action=domains"><i class="fa fa-globe" ></i> Domain</a></li>
<li><a href="https://www.hostitsmart.com/manage/supporttickets.php"><i class="fa fa-life-ring" ></i> Support</a></li>
</ul>
<div class="menu_footer"><a href="javascript:void(0);" class="btn" id="logoutlink" onclick="do_logout();" title="Logout">Logout</a></div>
    ...
    <script type="text/javascript">
        function do_logout() { $.get("{{url('https://www.hostitsmart.com/manage/hits_logout.php')}}", function () {
