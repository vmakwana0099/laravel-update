...
<ul>
<li><a href="{{ config('app.api_url') }}/clientarea.php"><i class="fa fa-user" ></i> My Profile</a></li>
<li><a href="{{ config('app.api_url') }}/clientarea.php?action=invoices"><i class="fa fa-file-text-o" ></i> Invoices</a></li>
<li><a href="{{ config('app.api_url') }}/clientarea.php?action=services"><i class="fa fa-cogs" ></i> Products/Services</a></li>
<li><a href="{{ config('app.api_url') }}/clientarea.php?action=domains"><i class="fa fa-globe" ></i> Domain</a></li>
<li><a href="{{ config('app.api_url') }}/supporttickets.php"><i class="fa fa-life-ring" ></i> Support</a></li>
</ul>
<div class="menu_footer"><a href="javascript:void(0);" class="btn" id="logoutlink" onclick="do_logout();" title="Logout">Logout</a></div>
    ...
    <script type="text/javascript">
        function do_logout() { $.get("{{ config('app.api_url') }}/hits_logout.php", function () {
