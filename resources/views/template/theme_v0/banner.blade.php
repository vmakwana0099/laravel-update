            ...
            <div class="carousel-item {{$Banner_Active}} {{ $slider_class }}" <?php echo $mobilespecificbanner; ?>> 
                ...
                @elseif(empty($bannerImg->txtImageName) && $bannerImg->dasktopSourceUrl !== '' )
                    ...
                    @if ($bannerImg->varBannerVersion == "img_banner")
                        <picture>
                            ...
                            @else
                                          ...
                                          <source media="(max-width: 767px)" srcset="{{ $ipadurl }}">
                                        <source media="(max-width: 768px)" srcset="{{ $ipadurl }}">
                                        <img src="{{ $ipadurl }}" alt="{{ $bannerImg->varTagLine }}" title="{{ $bannerImg->varTagLine }}" />
                            @endif
                    ...
                    @elseif($bannerImg->varBannerVersion == "vid_banner")
                        @if($uagent == "mobile")
                                ...
                                @else
                                    <?php $ipadurl = str_replace("Mobile","I-Pad",$bannerImg->mobileSourceUrl); 
                                          $ipadurlimg = str_replace("Mobile","I-Pad",$bannerImg->mobileSourceUrl);?>
                                          <?php $ext = pathinfo($bannerImg->mobileSourceUrl, PATHINFO_EXTENSION) ?>
                                        <?php $ext = "m4v";?> <?php /* Temparley patch convert jpg to m4v for vpas hosting banner */ ?>
                                    ...
                                    @elseif($ext == "mp4" || $ext == "m4v" )
                                        ...
                                        <video id="video" muted autoplay="autoplay" loop="loop" controls="true" style="width:100%;" preload="auto" alt="" poster="{{ $ipadurlimg }}">
                        ...
                        <!-- Strat Vk 5/2/2020 for combine banner for video or image -->
                        ...
                        @endif
                        <!-- End Vk 5/2/2020 for combine banner for video or image -->
