                ...
                <div class="footers-links links-small d-none d-sm-block aos-init" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <ul>
                        @if(session()->has('frontlogin'))
                            ...
                            <li><a href="<?php echo $apiUrl; ?>" target="_blank" title="My Account" id="my_account">My Account</a></li>
                            <li><a href="<?php echo $apiUrl; ?>/index.php?rp=/cart/domain/renew" target="_blank" title="My Renewals">My Renewals</a></li>
