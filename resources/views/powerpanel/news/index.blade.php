...
<!--				<select class="form-control bs-select select2" id="category_id" name="category_id">
                ...
                <div class="pull-right">
                    <a class="btn btn-green-drake" href="{{ url('powerpanel/news/add') }}">{{ trans('template.newsModule.addNews') }}</a>
                </div>
                @endpermission
            ...
            <div class="portlet-body">
                <p style="background:rgba(16, 128, 242,0.08);color:rgba(16, 128, 242, 1);width:100%;padding:10px 15px"> {{ trans('template.newsModule.listingNote') }}</p>
                    ...
                    <table class="new_table_desing table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="12%" align="left">{{ trans('template.common.dateandtime') }}</th>								
                                <th width="5%" align="center">{{ trans('template.powerPanelDashboard.webHits') }}</th>
                                <th width="5%" align="center">{{ trans('template.powerPanelDashboard.mobileHits') }}</th>
                                <!--<th width="5%" align="center">{{ trans('template.common.order') }}</th>-->
                                <th width="5%" align="center">{{ trans('template.common.publish') }}</th>
                                <th width="5%" align="right">{{ trans('template.common.actions') }}</th>
                            </tr>
                        </thead>
                        <tbody> </tbody>
                    </table>
    ...
    <script src="{{ url('resources/pages/scripts/news-datatables-ajax.js') }}" type="text/javascript"></script>
