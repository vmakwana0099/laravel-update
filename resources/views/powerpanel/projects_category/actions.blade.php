                            ...
                            <div class="col-md-12">
                                <div class="tab-pane active" id="general">
                                    <div class="portlet-body form_pattern">
                                        {!! Form::open(['method' => 'post','id'=>'frmProjectCategory']) !!}
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group @if($errors->first('title')) has-error @endif form-md-line-input">
                                                        {!! Form::text('title', isset($projectCategory->varTitle)?$projectCategory->varTitle:old('title'), array('maxlength' => 150, 'class' => 'form-control hasAlias seoField maxlength-handler','data-url' => 'powerpanel/project-category','placeholder' => trans('template.common.title'),'autocomplete'=>'off')) !!}
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <!-- code for alias -->
                                                    {!! Form::hidden(null, null, array('class' => 'hasAlias','data-url' => 'powerpanel/project-category')) !!}
                                                    {!! Form::hidden('alias', isset($projectCategory->alias->varAlias)?$projectCategory->alias->varAlias:old('alias'), array('class' => 'aliasField')) !!}
                                                    {!! Form::hidden('oldAlias', isset($projectCategory->alias->varAlias)?$projectCategory->alias->varAlias:old('alias')) !!}
                                                    <div class="form-group alias-group {{!isset($projectCategory->alias->varAlias)?'hide':''}}">
                                            ...
                                            <?php /* <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group @if($errors->first('short_description')) has-error @endif form-md-line-input">
                                                        {!! Form::textarea('short_description', isset($projectCategory->txtShortDescription)?$projectCategory->txtShortDescription:old('short_description'), array('maxlength' => isset($settings->short_desc_length)?$settings->short_desc_length:400,'class' => 'form-control seoField maxlength-handler','id'=>'varShortDescription','rows'=>'3')) !!}
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group @if($errors->first('description')) has-error @endif ">
                                                        ...
                                                        {!! Form::textarea('description', isset($projectCategory->txtDescription)?$projectCategory->txtDescription:old('description'), array('placeholder' => trans('template.common.description'),'class' => 'form-control','id'=>'txtDescription')) !!}
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class=" form-md-line-input nopadding">
                                                        @include('powerpanel.partials.seoInfo',['form'=>'frmProjectCategory','inf'=>isset($metaInfo)?$metaInfo:false,'metaRequired'=>false])
                                                    </div>
                                                </div>
                                            </div> */ ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    /* if(!isset($projectCategory->intDisplayOrder)){
                                                    ...
                                                    <div class="form-group @if($errors->first('display_order')) has-error @endif form-md-line-input">
                                                        {!! Form::text('display_order', isset($projectCategory->intDisplayOrder) ? $projectCategory->intDisplayOrder : 1, $display_order_attributes) !!}
                                                ...
                                                <div class="col-md-6">
                                                    @include('powerpanel.partials.displayInfo',['display' => isset($projectCategory->chrPublish)?$projectCategory->chrPublish:null ])
                                                </div>
                                                @else
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <a class="btn btn-outline red" href="{{ url('powerpanel/project-category') }}">{{ trans('template.common.cancel') }}</a>
                                                </div>
                                            </div>
                                        </div>
                                        {!! Form::close() !!}
...
<script type="text/javascript">
    window.site_url = '{!! url("/") !!}';
    var seoFormId = 'frmProjectCategory';
    var user_action = "{{ isset($projectCategory)?'edit':'add' }}";
...
<script src="{{ url('resources/pages/scripts/projects_category_validations.js') }}" type="text/javascript"></script>
