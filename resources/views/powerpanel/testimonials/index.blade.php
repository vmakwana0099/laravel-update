        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            ...
            <div class="portlet-title select_box service_select_box">
                ...
                <div class="pull-right">
                    <a class="btn btn-green-drake" href="{{ url('powerpanel/testimonials/add') }}">{{ trans('template.testimonialsModule.addTestimonials') }}</a>
                </div>
                @endpermission
                <div class="clearfix"></div>
                <div class="portlet-body">
                    <p style="background:rgba(16, 128, 242,0.08);color:rgba(16, 128, 242, 1);width:100%;padding:10px 15px"> {{ trans('template.testimonialsModule.listingNote') }}</p>
            ...
            @else
            @include('powerpanel.partials.addrecordsection',['type'=>Config::get('Constant.MODULE.TITLE'), 'adUrl' => url('powerpanel/testimonials/add')])
            @endif      
        </div>
    </div>
</div>
...
<script type="text/javascript">
    window.site_url = '{!! url("/") !!}';
    var DELETE_URL = '{!! url("/powerpanel/testimonials/DeleteRecord") !!}';
...
<script src="{{ url('resources/pages/scripts/testimonials-datatables-ajax.js') }}" type="text/javascript"></script>
