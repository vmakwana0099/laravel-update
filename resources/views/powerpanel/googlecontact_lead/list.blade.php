        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <table class="new_table_desing table table-striped table-bordered table-hover table-checkable dataTable" id="datatable_ajax">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="10%" align="center">Number of licenses</th>
                                <th width="10%" align="center">Company</th>
                    ...
                    @permission('google-contact-us-delete')
...
<script type="text/javascript">
    window.site_url = '{!! url("/") !!}';
    var DELETE_URL = '{!! url("/powerpanel/google-contact-us/DeleteRecord") !!}';
</script>
...
<script src="{{ url('resources/pages/scripts/google-contactleads-datatables-ajax.js') }}" type="text/javascript"></script>
