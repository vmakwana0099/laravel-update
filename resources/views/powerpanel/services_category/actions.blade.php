										...
										<div class="form-body">
											<div class="row">
												<div class="col-md-12">
													<div class="form-group @if($errors->first('title')) has-error @endif form-md-line-input">
														{!! Form::text('title', isset($serviceCategory->varTitle) ? $serviceCategory->varTitle : old('title'), array('maxlength' => 150, 'class' => 'form-control hasAlias seoField maxlength-handler','data-url' => 'powerpanel/service-category','placeholder' => trans('template.common.title'),'autocomplete'=>'off')) !!}
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group @if($errors->first('description')) has-error @endif ">
														...
														{!! Form::textarea('description', isset($serviceCategory->txtDescription) ? $serviceCategory->txtDescription : old('description'), array('placeholder' => trans('template.common.description'),'class' => 'form-control','id'=>'txtDescription')) !!}
											...
											<div class="row">
												...
												@php
														...
														if(!isset($serviceCategory->intDisplayOrder)){
										...
										<div class="form-actions">
											<div class="row">
												<div class="col-md-12">
													...
													<a class="btn btn-outline red" href="{{ url('powerpanel/service-category') }}">{{ trans('template.common.cancel') }}</a>
												</div>
											</div>
										</div>
										{!! Form::close() !!}
...
<script src="{{ url('resources/pages/scripts/services_category_validations.js') }}" type="text/javascript"></script>
