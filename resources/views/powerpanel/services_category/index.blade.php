		...
		@if($iTotalRecords > 0)
			<div class="portlet-title select_box new_select_box">
			  <span class="title">{{ trans('template.common.filterby') }}:</span>
				...
				@permission('service-category-create')
					<div class="pull-right">
						<a class="btn btn-green-drake" href="{{ url('powerpanel/service-category/add') }}">{{ trans('template.serviceCategoryModule.addServiceCategory') }}</a>
					</div>
				@endpermission
				<div class="clearfix"></div>
				<div class="portlet-body">
				<p style="background:rgba(16, 128, 242,0.08);color:rgba(16, 128, 242, 1);width:100%;padding:10px 15px"> {{ trans('template.serviceCategoryModule.listingNote') }}</p>
					<div class="table-container">
					  <div class="table-actions-wrapper">
						...
						@permission('service-category-delete')						  
...
<script src="{{ url('resources/pages/scripts/services-category-datatables-ajax.js') }}" type="text/javascript"></script>
