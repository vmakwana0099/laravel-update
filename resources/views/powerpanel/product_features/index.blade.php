    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-datatable">
            ...
            <div class="portlet-title select_box">
                ...
                @permission('product-features-create')
                <div class="pull-right">
                    <a class="btn btn-green-drake" href="{{ url('powerpanel/product-features/add') }}">{{ trans('template.productfeaturesModule.addProductFeatures') }} </a>
                </div>
                @endpermission
            </div>
            <div class="portlet-body">
                <p style="background:rgba(16, 128, 242,0.08);color:rgba(16, 128, 242, 1);width:100%;padding:10px 15px"> {{ trans('template.productfeaturesModule.listingNote') }}</p>
                <div class="table-container">
                    ...
                    <table class="new_table_desing table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="15%" align="left">{{ trans('template.productfeaturesModule.productcategory') }}</th>
                                <th width="15%" align="left">{{ trans('template.productfeaturesModule.product') }}</th>
                    ...
                    @permission('product-features-delete')
            ...
            @else
            @include('powerpanel.partials.addrecordsection',['type'=>Config::get('Constant.MODULE.TITLE'), 'adUrl' => url('powerpanel/product-features/add')])
            @endif
        </div>
    </div>
</div>
...
<script type="text/javascript">
    window.site_url = '{!! url("/") !!}';
    var DELETE_URL = '{!! url("/powerpanel/product-features/DeleteRecord") !!}';
</script>
...
<script src="{{ url('resources/pages/scripts/product_features-datatables-ajax.js') }}" type="text/javascript"></script>
