						...
						<div class="table-container">
							 ...
							 <table class="new_table_desing table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
								<thead>
									...
									<th width="40%" align="left">{{ trans('template.newslettersModule.user')  }}</th>
									<th width="15%" align="center">{{ trans('template.newslettersModule.subscribed') }}</th>
									<th width="15%" align="center">{{ trans('template.common.ip') }} </th>
									<th width="15%" align="center">{{ trans('template.common.received_date_time') }}</th>
									</tr>
								</thead>
								<tbody> </tbody>
							 </table>
							...
							@endpermission
							<a href="#selectedRecords" class="btn-sm btn btn-green-drake right_bottom_btn ExportRecord" data-toggle="modal"> {{ trans('template.newslettersModule.export') }}</a>
	...
	<div class="modal-dialog">
		<div class="modal-vertical">	
			<div class="modal-content">
					...
					<div class="modal-body text-center">{{ trans('template.newslettersModule.noExport') }}</div>
	...
	<div class="modal-dialog">
		<div class="modal-vertical">	
			<div class="modal-content">
					...
					<div class="modal-body text-center">{{ trans('template.newslettersModule.recordsExport') }}</div>
					<div class="modal-footer">
						<div align="center">
							<div class="md-radio-inline">
								<div class="md-radio">
									...
									<label for="selected_records">
										...
										<span class="box"></span> {{ trans('template.newslettersModule.selectedRecords') }}
									</label>
								</div>
								<div class="md-radio">
									...
									<label for="all_records">
										<span class="inc"></span>
										<span class="check"></span>
										<span class="box"></span> {{ trans('template.newslettersModule.allRecords') }}
									</label>
								</div>
							</div>
						</div>
	...
	<div class="modal-dialog">
		<div class="modal-vertical">	
			<div class="modal-content">
				...
				<div class="modal-body text-center">{{ trans('template.newslettersModule.leastRecord') }}</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-green-drake" data-dismiss="modal">{{ trans('template.common.ok') }}</button>
				</div>
			</div>
...
<script src="{{ url('resources/pages/scripts/subscription-datatables-ajax.js') }}" type="text/javascript"></script>
