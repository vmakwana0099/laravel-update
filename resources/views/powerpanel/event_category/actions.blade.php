										...
										<div class="form-body">
											<div class="row">
												<div class="col-md-12">
													<div class="form-group @if($errors->first('title')) has-error @endif form-md-line-input">
														{!! Form::text('title', isset($eventCategory->varTitle)?$eventCategory->varTitle:old('title'), array('maxlength' => 150, 'class' => 'form-control hasAlias seoField maxlength-handler','data-url' => 'powerpanel/event-category','placeholder' => trans('template.common.title'),'autocomplete'=>'off')) !!}
											...
											<div class="row">
												<div class="col-md-12">
													...
													<div class="form-group alias-group {{!isset($eventCategory->alias->varAlias)?'hide':''}}">
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group @if($errors->first('short_description')) has-error @endif form-md-line-input">
														{!! Form::textarea('short_description', isset($eventCategory->txtShortDescription)?$eventCategory->txtShortDescription:old('short_description'), array('maxlength' => isset($settings->short_desc_length)?$settings->short_desc_length:400,'class' => 'form-control seoField maxlength-handler','id'=>'varShortDescription','rows'=>'3')) !!}
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group @if($errors->first('description')) has-error @endif ">
														...
														{!! Form::textarea('description', isset($eventCategory->txtDescription)?$eventCategory->txtDescription:old('description'), array('placeholder' => trans('template.common.description'),'class' => 'form-control','id'=>'txtDescription')) !!}
											...
											<div class="row">
												<div class="col-md-12">
													<div class=" form-md-line-input nopadding">
														@include('powerpanel.partials.seoInfo',['form'=>'frmEventCategory','inf'=>isset($metaInfo)?$metaInfo:false,'metaRequired'=>false])
													</div>
												</div>
											</div>
											...
											<div class="row">
												...
												@php
													...
													if(!isset($eventCategory->intDisplayOrder)){
												...
												@endphp
													<div class="form-group @if($errors->first('display_order')) has-error @endif form-md-line-input">
														{!! Form::text('display_order', isset($eventCategory->intDisplayOrder)?$eventCategory->intDisplayOrder:$total, $display_order_attributes) !!}
												...
												<div class="col-md-6">
													@include('powerpanel.partials.displayInfo',['display' => isset($eventCategory->chrPublish)?$eventCategory->chrPublish:null])
												</div>
												@else
												<div class="col-md-6">
													<div class="form-group">
										...
										<div class="form-actions">
											<div class="row">
												<div class="col-md-12">
													...
													<a class="btn btn-outline red" href="{{ url('powerpanel/event-category') }}">{{ trans('template.common.cancel') }}</a>
												</div>
											</div>
										</div>
										{!! Form::close() !!}
...
<script src="{{ url('resources/pages/scripts/event_category_validations.js') }}" type="text/javascript"></script>
