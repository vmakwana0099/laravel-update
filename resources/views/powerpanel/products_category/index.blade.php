...
<div class="row">
        ...
        <div class="portlet light portlet-fit portlet-datatable">
            ...
            <div class="portlet-title select_box new_select_box">
                ...
                <div class="pull-right">
                    <a class="btn btn-green-drake" href="{{ url('powerpanel/product-category/add') }}">
                        {{ trans('template.productCategoryModule.addProductCategory') }}
                    </a>
                </div>
                @endpermission
                <div class="clearfix"></div>
                <div class="portlet-body">
                    <p style="background:rgba(16, 128, 242,0.08);color:rgba(16, 128, 242, 1);width:100%;padding:10px 15px"> {{ trans('template.productCategoryModule.listingNote') }}</p>
                        ...
                        <table class="new_table_desing table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                            <thead>
                                <tr role="row" class="heading">												
                                    ...
                                    <th width="10%" align="center">{{ trans('template.common.view') }}</th>
            ...
            <!-- End: life time stats -->
            @else
            @include('powerpanel.partials.addrecordsection',['type'=>Config::get('Constant.MODULE.TITLE'), 'adUrl' => url('powerpanel/product-category/add')])
            @endif		
        </div>
    </div>
    <!-- /.modal -->
    ...
    <script type="text/javascript">
        window.site_url = '{!! url("/") !!}';
        var DELETE_URL = '{!! url("/powerpanel/product-category/DeleteRecord") !!}';
    </script>
    ...
    <script src="{{ url('resources/pages/scripts/product-category-datatables-ajax.js') }}" type="text/javascript"></script>
