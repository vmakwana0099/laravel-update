                                ...
                                <div class="tab-pane active" id="general">
                                    <div class="portlet-body form_pattern">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row" id="product_div" style="display: none">
                                                <div class="col-md-12">
                                                    <div class="form-group @if($errors->first('product_id')) has-error @endif">                                                                            
                                                        <label class="form_title" for="product_id">{{ trans('template.common.selectproduct') }} </label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group @if($errors->first('varProductFeatures')) has-error @endif form-md-line-input">
                                                        {!! Form::textarea('varProductFeatures', isset($deals->varProductFeatures)?$deals->varProductFeatures:old('varProductFeatures'), array('maxlength' => isset($settings->short_desc_length)?$settings->short_desc_length:500,'class' => 'form-control','id'=>'varProductFeatures','rows'=>'3')) !!}
                                                        <label class="form_title">Product's Features <span aria-required="true" class="required"> * </span></label>
                                                        <span class="help-block">{{ $errors->first('varProductFeatures') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">                                                                        
                                                    <div class="form-group  form-md-line-input">
                                                        ...
                                                        <label class="form_title" class="site_name">{{ trans('template.bannerModule.buttonlink') }} </label>
                                                        <span class="help-block">
