										...
										<div class="form-body">
											<div class="row">
												<div class="col-md-12">
													<div class="form-group @if($errors->first('title')) has-error @endif form-md-line-input">
														{!! Form::text('title', isset($newsCategory->varTitle)?$newsCategory->varTitle:old('title'), array('maxlength' => 150, 'class' => 'form-control hasAlias seoField maxlength-handler','data-url' => 'powerpanel/news-category','placeholder' => trans('template.common.title'),'autocomplete'=>'off')) !!}
											...
											<div class="row">
												<div class="col-md-12">
													...
													<div class="form-group alias-group {{!isset($newsCategory->alias->varAlias)?'hide':''}}">
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group @if($errors->first('short_description')) has-error @endif form-md-line-input">
														{!! Form::textarea('short_description', isset($newsCategory->txtShortDescription)?$newsCategory->txtShortDescription:old('short_description'), array('maxlength' => isset($settings->short_desc_length)?$settings->short_desc_length:400,'class' => 'form-control seoField maxlength-handler','id'=>'varShortDescription','rows'=>'3')) !!}
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group @if($errors->first('description')) has-error @endif ">
														...
														{!! Form::textarea('description', isset($newsCategory->txtDescription)?$newsCategory->txtDescription:old('description'), array('placeholder' => trans('template.common.description'),'class' => 'form-control','id'=>'txtDescription')) !!}
											...
											<div class="row">
												<div class="col-md-12">
													<div class=" form-md-line-input nopadding">
														@include('powerpanel.partials.seoInfo',['form'=>'frmNewsCategory','inf'=>isset($metaInfo)?$metaInfo:false,'metaRequired'=>false])
													</div>
												</div>
											</div>
											...
											<div class="row">
												...
												@php
													...
													if(!isset($newsCategory->intDisplayOrder)){
												...
												@endphp
													<div class="form-group @if($errors->first('display_order')) has-error @endif form-md-line-input">
														{!! Form::text('display_order', isset($newsCategory->intDisplayOrder)?$newsCategory->intDisplayOrder:$total, $display_order_attributes) !!}
												...
												<div class="col-md-6">
													@include('powerpanel.partials.displayInfo',['display' => isset($newsCategory->chrPublish)?$newsCategory->chrPublish:null])
												</div>
												@else
												<div class="col-md-6">
													<div class="form-group">
										...
										<div class="form-actions">
											<div class="row">
												<div class="col-md-12">
													...
													<a class="btn btn-outline red" href="{{ url('powerpanel/news-category') }}">{{ trans('template.common.cancel') }}</a>
												</div>
											</div>
										</div>
										{!! Form::close() !!}
...
<script src="{{ url('resources/pages/scripts/news_category_validations.js') }}" type="text/javascript"></script>
