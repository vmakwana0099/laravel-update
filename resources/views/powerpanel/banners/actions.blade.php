                            ...
                            <div class="col-md-12">
                                <div class="portlet-body form_pattern">
                                    ...
                                    <div class="form-body">
                                        ...
                                        @if ((isset($banners->chr_full_width) && $banners->chr_full_width == 'Y') || old('full_width') == 'Y')
                                            @php $Full_checked_yes = 'checked' @endphp
                                        @else
                                            @php $Full_checked_yes = '' @endphp
                                        @endif
                                        
                                        @if ((isset($banners->chr_full_width) && $banners->chr_full_width == 'N') || old('full_width') == 'N' || (!isset($banners->chr_full_width) && old('full_width') == null))
                                            @php $ichecked_fullwidth_yes = 'checked' @endphp
                                        @else
                                            @php $ichecked_fullwidth_yes = '' @endphp
                                        @endif
                                        <div class="form-group">
                                            <label class="form_title" for="full_width">{!! trans('template.bannerModule.fullwidthinnerbanner') !!} <span aria-required="true" class=" "> </span></label>
                                            <div class="md-radio-inline">
                                                <div class="md-radio">
                                                    <input type="radio" {{ $Full_checked_yes }}  value="Y" id="yes" name="full_width" class="md-radiobtn banner">
                                                    <label for="yes">
                                                        <span class="inc"></span>
                                                        <span class="check"></span>
                                                        <span class="box"></span> {!! trans('template.bannerModule.yes') !!}
                                                    </label>
                                                </div>
                                                <div class="md-radio">
                                                    <input type="radio" {{ $ichecked_fullwidth_yes }} value="N" id="no" name="full_width" class="md-radiobtn banner">
                                                    <label for="no">
                                                        <span class="inc"></span>
                                                        <span class="check"></span>
                                                        <span class="box"></span> {!! trans('template.bannerModule.no') !!}
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @if ( (isset($banners->varBannerVersion) && $banners->varBannerVersion == 'html_banner') || old('bannerversion') == 'html_banner')
                                            @php $checked_html_yes = 'checked'; @endphp
                                        @else
                                            @php $checked_html_yes = ''; @endphp
                                        @endif
                                        ...
                                        <div class="form-group bannerversion {{ $errors->has('bannerversion') ? ' has-error' : '' }}">
                                            ...
                                            <div class="md-radio-inline">
                                                ...
                                                <div class="md-radio"> {{-- if html banner radio --}}
                                                    <input type="radio" {{ $checked_html_yes }} value="html_banner" id="html_banner" name="bannerversion" class="md-radiobtn versionradio">
                                                    <label for="html_banner">
                                                        <span class="inc"></span>
                                                        <span class="check"></span>
                                                        <span class="box"></span> {!! trans('template.bannerModule.htmlBanner') !!}
                                                    </label>
                                                </div>
                                            </div>
                                            <span class="help-block">
                                        ...
                                        @if ( isset($banners->dasktopSourceUrl) && $banners->dasktopSourceUrl !== '' || old('bannerfrom')=='from_url' || (!isset($banners->dasktopSourceUrl) && old('bannerfrom') == null) )
                                            @php $fromchecked_vid_url = 'checked' @endphp
                                        @else
                                            @php $fromchecked_vid_url = '' @endphp
                                        @endif

                                        @if ( isset($banners->dasktopSourceUrl) && $banners->dasktopSourceUrl == '' || old('bannerfrom')=='from_src' || (!isset($banners->dasktopSourceUrl) && old('from_src') == null) )
                                            @php $fromichecked_vid_src = 'checked' @endphp
                                        @else
                                            @php $fromichecked_vid_src = '' @endphp
                                        @endif

                                        {{-- vikram 10/10/2019 --}}
                                        <div style="display: block;" class="form-group bannerfrom {{ $errors->has('bannerfrom') ? ' has-error' : '' }}">
                                            <label class="form_title" for="bannerfrom">{!! trans('template.bannerModule.bannerfrom') !!} <span aria-required="true" class="required"> * </span></label>
                                            <div class="md-radio-inline">
                                                <div class="md-radio">
                                                    <input type="radio" {{ $fromchecked_vid_url }}  value="from_url" id="from_url" name="bannerfrom" class="md-radiobtn bannerfromradio">
                                                    <label for="from_url">
                                                        <span class="inc"></span>
                                                        <span class="check"></span>
                                                        <span class="box"></span> {!! trans('template.bannerModule.from_url') !!}
                                                    </label>
                                                </div>
                                                <div class="md-radio">
                                                    <input type="radio" {{ $fromichecked_vid_src }} value="from_src" id="from_src" name="bannerfrom" class="md-radiobtn bannerfromradio">
                                                    <label for="from_src">
                                                        <span class="inc"></span>
                                                        <span class="check"></span>
                                                        <span class="box"></span> {!! trans('template.bannerModule.from_src') !!}
                                                    </label>
                                                </div>
                                            </div>
                                            <span class="help-block">
                                                <strong>{{ $errors->first('bannerfrom') }}</strong>
                                            </span>
                                        </div>
                                        {{-- end --}}
                                        ...
                                        {{-- html banner code start --}}
                                        <div class="form-group" id="txtHtmlBanner_div">
                                            <label class="form_title @if($errors->first('display_order')) has-error @endif" for="htmlbanner">{!! trans('template.common.htmlbanner') !!} <span aria-required="true" class="required"> * </span></label>
                                            {!! Form::textarea('htmlbanner',isset($banners->txtbannerhtml)?$banners->txtbannerhtml:old('htmlbanner'), array('class' => 'form-control','id'=>'txtHtmlBanner')) !!}
                                            <span class="help-block">
                                                <strong>{{ $errors->first('htmlbanner') }}</strong>
                                            </span>
                                        </div>
                                        {{-- html banner code end --}}

                                        {{-- VK date => 04/10/2019 --}}
                                        <div class="form-group {{ $errors->has('dsk_source_url') ? ' has-error' : '' }}  form-md-line-input" id="dsk_source_url_div">
                                            {!! Form::text('dsk_source_url', isset($banners->dasktopSourceUrl)?$banners->dasktopSourceUrl:old('dsk_source_url'), array('class' => 'form-control input-sm maxlength-handler', 'data-url' => 'powerpanel/banners','id' => 'dsk_source_url','placeholder' => trans('template.common.dsk_source_url'),'autocomplete'=>'off')) !!}
                                            <label class="form_title" for="dsk_source_url">{!! trans('template.common.dsk_source_url') !!} <span aria-required="true" class="required"> * </span></label>
                                            <span style="color:#e73d4a">
                                                {{ $errors->first('dsk_source_url') }}
                                            </span>
                                        </div>
                                        <div class="form-group {{ $errors->has('mobi_source_url') ? ' has-error' : '' }}  form-md-line-input" id="mobi_source_url_div">
                                            {!! Form::text('mobi_source_url', isset($banners->mobileSourceUrl)?$banners->mobileSourceUrl:old('mobi_source_url'), array('class' => 'form-control input-sm maxlength-handler', 'data-url' => 'powerpanel/banners','id' => 'mobi_source_url','placeholder' => trans('template.common.mobi_source_url'),'autocomplete'=>'off')) !!}
                                            <label class="form_title" for="mobi_source_url">{!! trans('template.common.mobi_source_url') !!} <span aria-required="true" class="required"> * </span></label>
                                            <span style="color:#e73d4a">
                                                {{ $errors->first('mobi_source_url') }}
                                            </span>
                                        </div>
                                        <div class="form-group {{ $errors->has('ipad_source_url') ? ' has-error' : '' }}  form-md-line-input" id="ipad_source_url_div">
                                            {!! Form::text('ipad_source_url', isset($banners->ipadSourceUrl)?$banners->ipadSourceUrl:old('ipad_source_url'), array('class' => 'form-control input-sm maxlength-handler', 'data-url' => 'powerpanel/banners','id' => 'ipad_source_url','placeholder' => trans('template.common.ipad_source_url'),'autocomplete'=>'off')) !!}
                                            <label class="form_title" for="ipad_source_url">{!! trans('template.common.ipad_source_url') !!} <span aria-required="true" class="required"> * </span></label>
                                            <span style="color:#e73d4a">
                                                {{ $errors->first('ipad_source_url') }}
                                            </span>
                                        </div>

                                        <div class="form-group {{ $errors->has('txt_custom_csspath') ? ' has-error' : '' }}  form-md-line-input" id="txt_custom_csspath_div">
                                        {{-- <div class="row container"> --}}
                                            {{-- <div class="form-group col-md-4 form-md-line-input">
                                                {!! Form::text('dsk_source_class', isset($banners->dsk_source_class)?$banners->dsk_source_class:old('dsk_source_class'), array('maxlength' => 500, 'class' => 'form-control input-sm maxlength-handler', 'id' => 'dsk_source_class','placeholder' => trans('template.common.dsk_source_class'),'autocomplete'=>'off')) !!}
                                                <label class="form_title" for="dsk_source_class">{!! trans('template.common.dsk_source_class') !!} <span aria-required="true"> * </span></label>
                                                <span style="color:#e73d4a">
                                                    {{ $errors->first('dsk_source_class') }}
                                                </span>
                                            </div>
                                            <div class="form-group col-md-4 form-md-line-input">
                                                {!! Form::text('mobi_source_class', isset($banners->mobi_source_class)?$banners->mobi_source_class:old('mobi_source_class'), array('maxlength' => 500, 'class' => 'form-control input-sm maxlength-handler', 'id' => 'mobi_source_class','placeholder' => trans('template.common.mobi_source_class'),'autocomplete'=>'off')) !!}
                                                <label class="form_title" for="mobi_source_class">{!! trans('template.common.mobi_source_class') !!} <span aria-required="true"> * </span></label>
                                                <span style="color:#e73d4a">
                                                    {{ $errors->first('mobi_source_class') }}
                                                </span>
                                            </div>
                                            <div class="form-group col-md-4 form-md-line-input">
                                                {!! Form::text('ipad_source_class', isset($banners->ipad_source_class)?$banners->ipad_source_class:old('ipad_source_class'), array('maxlength' => 500, 'class' => 'form-control input-sm maxlength-handler', 'id' => 'ipad_source_class','placeholder' => trans('template.common.ipad_source_class'),'autocomplete'=>'off')) !!}
                                                <label class="form_title" for="ipad_source_class">{!! trans('template.common.ipad_source_class') !!} <span aria-required="true"> * </span></label>
                                                <span style="color:#e73d4a">
                                                    {{ $errors->first('ipad_source_class') }}
                                                </span>
                                            </div> --}}
                                            <label class="form_title" for="txt_custom_csspath">{!! trans('template.common.txt_custom_csspath') !!} <span aria-required="true" class="required"> * </span></label>
                                            {!! Form::text('txt_custom_csspath', isset($banners->txt_custom_csspath)?$banners->txt_custom_csspath:old('txt_custom_csspath'), array('class' => 'form-control input-sm maxlength-handler', 'data-url' => 'powerpanel/banners','id' => 'txt_custom_csspath','placeholder' => trans('template.common.txt_custom_csspath'),'autocomplete'=>'off')) !!}
                                            <span style="color:#e73d4a">
                                                {{ $errors->first('txt_custom_csspath') }}
                                            </span>
                                        </div>

                                        <input type="hidden" id="numbr" value="">
                                        <script>
                                            var Urls = "{{ url('powerpanel/banners/viewurltrue') }}"; 
                                        </script>

                                        <div class="row" id="button_link_div">
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group {{ $errors->has('img_id') ? ' has-error' : '' }}" id="imguploader">
                                        ...
                                        <div class="row viduploader" id="viduploader">
                                            <div class="col-md-12">
                                                <div class="image_thumb">
