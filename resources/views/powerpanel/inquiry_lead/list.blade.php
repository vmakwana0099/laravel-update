        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <table class="new_table_desing table table-striped table-bordered table-hover table-checkable dataTable" id="datatable_ajax">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="15%" align="left">{{ trans('template.inquiryleadModule.domain') }}</th>
                                <th width="15%" align="left">{{ trans('template.common.email') }}</th>
                                <th width="13%" align="center">{{ trans('template.common.phoneno') }}</th>
                                <th width="10%" align="center">{{ trans('template.inquiryleadModule.message') }}</th>
                    ...
                    <a href="#selectedRecords" class="btn-sm btn btn-green-drake right_bottom_btn ExportRecord" data-toggle="modal">{{ trans('template.inquiryleadModule.export') }}</a>				
                </div>
            </div>
            </div>
            @else
            @include('powerpanel.partials.addrecordsection',['marketlink' => 'https://www.netclues.com/social-media-marketing', 'type'=>'Domain Transfer Inquiry'])
            @endif
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-vertical">	
            <div class="modal-content">
                ...
                <div class="modal-body text-center">{{ trans('template.inquiryleadModule.noExport') }} </div>
    ...
    <div class="modal-dialog">
        <div class="modal-vertical">	
            <div class="modal-content">
                ...
                <div class="modal-body text-center">{{ trans('template.inquiryleadModule.recordsExport') }}</div>
                <div class="modal-footer">
                    <div align="center">
                        <div class="md-radio-inline">
                            <div class="md-radio">
                                ...
                                <label for="selected_records">
                                    ...
                                    <span class="box"></span> {{ trans('template.inquiryleadModule.selectedRecords') }}
                                </label>
                            </div>
                            <div class="md-radio">
                                ...
                                <label for="all_records">
                                    <span class="inc"></span>
                                    <span class="check"></span>
                                    <span class="box"></span>{{ trans('template.inquiryleadModule.allRecords') }} 
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-vertical">	
            <div class="modal-content">
                ...
                <div class="modal-body text-center">{{ trans('template.inquiryleadModule.leastRecord') }} </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-green-drake" data-dismiss="modal">{{ trans('template.common.ok') }} </button>
                </div>
            </div>
...
<script type="text/javascript">
    window.site_url = '{!! url("/") !!}';
    var DELETE_URL = '{!! url("/powerpanel/inquiry-leads/DeleteRecord") !!}';
</script>
...
<script src="{{ url('resources/pages/scripts/inquirylead-datatables-ajax.js') }}" type="text/javascript"></script>
