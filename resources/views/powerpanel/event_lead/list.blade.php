...
<div class="row">
	<div class="col-md-12">
				...
				<table class="new_table_desing table table-striped table-bordered table-hover table-checkable dataTable" id="datatable_ajax">
					<thead>
						<tr role="row" class="heading">
							...
							<th width="12%" align="center">{{ trans('template.common.phoneno') }}</th>
							<th width="10%" align="left">{{ trans('template.eventleadModule.eventName') }}</th>
							<th width="5%" align="center">{{ trans('template.common.interested') }}</th>
							<th width="5%" align="center">{{ trans('template.common.noofpeaople') }}</th>
							<th width="10%" align="center">{{ trans('template.eventleadModule.comments') }}</th>
		...
		@else
			@include('powerpanel.partials.addrecordsection',['marketlink' => '', 'type'=>'event'])
		@endif
	</div>
</div>
</div>
...
@section('scripts')
	<script type="text/javascript">
		window.site_url =  '{!! url("/") !!}';
		var DELETE_URL =  '{!! url("/powerpanel/event-leads/DeleteRecord") !!}';
	</script>
	...
	<script src="{{ url('resources/pages/scripts/eventlead-datatables-ajax.js') }}" type="text/javascript"></script>
