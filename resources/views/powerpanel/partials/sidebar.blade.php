    ...
    <div class="page-sidebar navbar-collapse collapse">
        <div class="scroller" style="max-height:calc(100vh - 100px);" data-rail-visible="1" data-rail-color="#fff" data-handle-color="#ccc">
            <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                (isset($menuArr['can-google-contact-us-list']) && $menuArr['can-google-contact-us-list'])
                )
                <li class="nav-item {{ (isset($menuArr['leadmg']) && $menuArr['leadmg']=='active')? 'open active' : '' }}">
                    ...
                    <ul class="sub-menu">
                        ...
                        @if(isset($menuArr['can-google-contact-us-list']) && $menuArr['can-google-contact-us-list'])
                        <li class="nav-item {{ $menuArr['google-contact_active'] }}">
                            <a title="{{ trans('template.sidebar.googlecontactuslead') }}" href="{{ url('powerpanel/google-contact-us') }}" class="nav-link ">
                                <i class="fa fa-phone"></i>
                                <span class="title">{{ trans('template.sidebar.googlecontactuslead') }}</span>
                                <span class="{{ $menuArr['google-contact_selected'] }}"></span>
                            </a>
                        </li>
                        @endif
                ...
                (isset($menuArr['can-testimonials-list']) && $menuArr['can-testimonials-list']) ||
                ...
                <li class="nav-item {{ (isset($menuArr['contmg']) && $menuArr['contmg']=='active')? 'open active' : '' }}">
                    ...
                    <ul class="sub-menu">
                        ...
                        @endif
                        @if(isset($menuArr['can-testimonials-list']) && $menuArr['can-testimonials-list'])
                        <li class="nav-item {{ $menuArr['testimonials_active'] }} {{ $menuArr['testimonials_open'] }}">
                            <a title="{{ trans('template.sidebar.testimonials') }}" href="{{ url('powerpanel/testimonials') }}" class="nav-link nav-toggle">
                                <i class="fa fa-quote-left" aria-hidden="true"></i>
                                <span class="title">{{ trans('template.sidebar.testimonials') }}</span>
                                <span class="{{ $menuArr['testimonials_selected'] }}"></span>
                            </a>
                        </li>
                        @endif
