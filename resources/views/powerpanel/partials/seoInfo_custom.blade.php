...
<div class="row">
	 <div class="col-md-6">	 
			<div class="form-group"> 
				<button type="button" id='auto-generate' class="btn dark btn-outline" onclick="generate_seocontent_custom('@if(!empty($form)){{ $form }}@endif');">{{ trans('template.common.autogenerate') }}</button>
		 </div>
	 </div>
</div>
<div class="row">
	 <div class="col-md-12">
			<div class="form-group @if($errors->first('varMetaTitle')) has-error @endif">
				 ...
				 {!! Form::text('varMetaTitle', $metaTitle , array('maxlength'=>'160','class' => 'form-control maxlength-handler','id'=>'varMetaTitle','autocomplete'=>'off')) !!}
