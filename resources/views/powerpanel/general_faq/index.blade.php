    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-datatable">
            ...
            <div class="portlet-title select_box">
                ...
                @permission('general-faq-create')
                <div class="pull-right">
                    <a class="btn btn-green-drake" href="{{ url('powerpanel/general-faq/add') }}">{{ trans('template.generalfaqModule.addFaq') }} </a>
                </div>
                @endpermission
            </div>
            <div class="portlet-body">
                <p style="background:rgba(16, 128, 242,0.08);color:rgba(16, 128, 242, 1);width:100%;padding:10px 15px"> {{ trans('template.generalfaqModule.listingNote') }}</p>
                    ...
                    <table class="new_table_desing table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="35%" align="left">{{ trans('template.common.question') }}</th>
                                <th width="10%" align="center">{{ trans('template.common.answer') }}</th>
            ...
            @else
            @include('powerpanel.partials.addrecordsection',['type'=>Config::get('Constant.MODULE.TITLE'), 'adUrl' => url('powerpanel/general-faq/add')])
            @endif
        </div>
    </div>
</div>
...
<script type="text/javascript">
    window.site_url = '{!! url("/") !!}';
    var DELETE_URL = '{!! url("/powerpanel/general-faq/DeleteRecord") !!}';
</script>
...
<script src="{{ url('resources/pages/scripts/general-faq-datatables-ajax.js') }}" type="text/javascript"></script>
