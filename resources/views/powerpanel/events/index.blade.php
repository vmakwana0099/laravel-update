			...
			<div class="portlet-title select_box event_select_box">
				...
				<div class="col-md-6 nopadding">
					...
					<div class="pull-right">
						<a class="btn btn-green-drake" title="{{ trans('template.eventModule.addEvent') }}" href="{{ url('powerpanel/events/add') }}">{{ trans('template.eventModule.addEvent') }}</a>
					</div>
					@endpermission
				...
				<div class="portlet-body">
					<p style="background:rgba(16, 128, 242,0.08);color:rgba(16, 128, 242, 1);width:100%;padding:10px 15px"> {{ trans('template.eventModule.listingNote') }}</p>
						...
						<table class="new_table_desing table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
							<thead>
								<tr role="row" class="heading">
									...
									<th width="20%" class="text-center">{{ trans('template.common.startDateAndTime') }}</th>
									<th width="20%" class="text-center">{{ trans('template.common.endDateAndTime') }}</th>
									<th width="15%" align="center">{{ trans('template.common.order') }}</th>
									<th width="10%" align="center">{{ trans('template.common.publish') }}</th>
									<th width="15%" class="text-right">{{ trans('template.common.actions') }}</th>
								</tr>
							</thead>
						<tbody> </tbody>
					</table>
...
<script src="{{ url('resources/pages/scripts/events-datatables-ajax.js') }}" type="text/javascript"></script>
