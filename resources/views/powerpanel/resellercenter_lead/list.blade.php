        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <table class="new_table_desing table table-striped table-bordered table-hover table-checkable dataTable" id="datatable_ajax">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="15%" align="left">{{ trans('template.resellercenterModule.fullname') }}</th>							
                                <th width="15%" align="left">{{ trans('template.resellercenterModule.interestedin') }}</th>
                                <th width="15%" align="left">{{ trans('template.common.email') }}</th>
                                <th width="13%" align="center">{{ trans('template.common.phoneno') }}</th>
                                <th width="10%" align="center">{{ trans('template.resellercenterModule.message') }}</th>
                    ...
                    @permission('reseller-center-delete')
                    <a href="javascript:;" class="btn-sm btn btn-outline red right_bottom_btn deleteMass">{{ trans('template.common.delete') }}</a>
                    @endpermission
                    <a href="#selectedRecords" class="btn-sm btn btn-green-drake right_bottom_btn ExportRecord" data-toggle="modal">{{ trans('template.resellercenterModule.export') }}</a>				
                </div>
            </div>
            </div>
            @else
            @include('powerpanel.partials.addrecordsection',['marketlink' => 'https://www.netclues.com/social-media-marketing', 'type'=>'reseller_center'])
            @endif
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-vertical">	
            <div class="modal-content">
                ...
                <div class="modal-body text-center">{{ trans('template.resellercenterModule.noExport') }} </div>
    ...
    <div class="modal-dialog">
        <div class="modal-vertical">	
            <div class="modal-content">
                ...
                <div class="modal-body text-center">{{ trans('template.resellercenterModule.recordsExport') }}</div>
                <div class="modal-footer">
                    <div align="center">
                        <div class="md-radio-inline">
                            <div class="md-radio">
                                ...
                                <label for="selected_records">
                                    ...
                                    <span class="box"></span> {{ trans('template.resellercenterModule.selectedRecords') }}
                                </label>
                            </div>
                            <div class="md-radio">
                                ...
                                <label for="all_records">
                                    <span class="inc"></span>
                                    <span class="check"></span>
                                    <span class="box"></span>{{ trans('template.resellercenterModule.allRecords') }} 
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-vertical">	
            <div class="modal-content">
                ...
                <div class="modal-body text-center">{{ trans('template.resellercenterModule.leastRecord') }} </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-green-drake" data-dismiss="modal">{{ trans('template.common.ok') }} </button>
                </div>
            </div>
...
<script type="text/javascript">
    window.site_url = '{!! url("/") !!}';
    var DELETE_URL = '{!! url("/powerpanel/reseller-center/DeleteRecord") !!}';
</script>
...
<script src="{{ url('resources/pages/scripts/resellercenterlead-datatables-ajax.js') }}" type="text/javascript"></script>
