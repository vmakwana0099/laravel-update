        ...
        <div class="portlet light portlet-fit portlet-datatable">
            ...
            <div class="portlet-title select_box">
                ...
                <div class="pull-right">
                    <a class="btn btn-green-drake" href="{{ url('powerpanel/faq/add') }}">{{ trans('template.faqModule.addFaq') }} </a>
                </div>
                @endpermission
            </div>
            <div class="portlet-body">
                <p style="background:rgba(16, 128, 242,0.08);color:rgba(16, 128, 242, 1);width:100%;padding:10px 15px"> {{ trans('template.faqModule.listingNote') }}</p>
                    ...
                    <table class="new_table_desing table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="38%" align="left">{{ trans('template.common.question') }}</th>
                                <th width="10%" align="center">{{ trans('template.common.answer') }}</th>
                                <th width="10%" align="left">{{ trans('template.faqModule.productcategory') }}</th>
                                <th width="10%" align="left">{{ trans('template.faqModule.product') }}</th>
...
<script src="{{ url('resources/pages/scripts/faq-datatables-ajax.js') }}" type="text/javascript"></script>
