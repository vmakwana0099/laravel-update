			  ...
			  <span class="title">{{ trans('template.common.filterby') }}:</span>
				...
				@permission('blog-category-create')
					<div class="pull-right">
						<a class="btn btn-green-drake" href="{{ url('powerpanel/blog-category/add') }}">
						{{ trans('template.blogCategoryModule.addBlogCategory') }}</a>
					</div>
				@endpermission
				<div class="clearfix"></div>
				<div class="portlet-body">
				<p style="background:rgba(16, 128, 242,0.08);color:rgba(16, 128, 242, 1);width:100%;padding:10px 15px"> {{ trans('template.blogCategoryModule.listingNote') }}</p>
...
<script src="{{ url('resources/pages/scripts/blog-category-datatables-ajax.js') }}" type="text/javascript"></script>
