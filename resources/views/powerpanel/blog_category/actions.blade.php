												...
												<div class="row">
													<div class="col-md-12">
													  <div class="form-group @if($errors->first('title')) has-error @endif form-md-line-input">
															{!! Form::text('title', isset($blogCategory->varTitle)?$blogCategory->varTitle:old('title'), array('maxlength' => 150, 'class' => 'form-control hasAlias seoField maxlength-handler','data-url' => 'powerpanel/blog-category','placeholder' => 'Title','autocomplete'=>'off')) !!}
											  ...
											  <div class="row">
													<div class="col-md-12">
													  <!-- code for alias -->
															...
															<div class="form-group alias-group {{!isset($blogCategory->alias->varAlias)?'hide':''}}">
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group @if($errors->first('short_description')) has-error @endif form-md-line-input">
															{!! Form::textarea('short_description', isset($blogCategory->txtShortDescription)?$blogCategory->txtShortDescription:old('short_description'), array('maxlength' => isset($settings->short_desc_length)?$settings->short_desc_length:400,'class' => 'form-control seoField maxlength-handler','id'=>'varShortDescription','rows'=>'3')) !!}
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group @if($errors->first('description')) has-error @endif ">
															...
															{!! Form::textarea('description', isset($blogCategory->txtDescription) ? $blogCategory->txtDescription : old('description'), array('placeholder' => trans('template.common.description'),'class' => 'form-control','id'=>'txtDescription')) !!}
												...
												<div class="row">
													<div class="col-md-12">
														<div class=" form-md-line-input nopadding">															
															@include('powerpanel.partials.seoInfo',['form'=>'frmBlogCategory','inf'=>isset($metaInfo)?$metaInfo:false,'metaRequired'=>false])
														</div>
													</div>
												</div>																										
											  <h3 class="form-section">{{ trans('template.common.displayinformation') }}</h3>
												<div class="row">	
												   ...
												   @php
															...
															if(!isset($blogCategory->intDisplayOrder)){
													  ...
													  <div class="form-group @if($errors->first('display_order')) has-error @endif form-md-line-input">
															{!! Form::text('display_order', isset($blogCategory->intDisplayOrder)?$blogCategory->intDisplayOrder:$total, $display_order_attributes) !!}
												...
												<div class="row">
													<div class="col-md-12">
													  <button type="submit" name="saveandedit" class="btn btn-green-drake" value="saveandedit">{!! trans('template.common.saveandedit') !!}</button>
														...
														<a class="btn btn-outline red" href="{{ url('powerpanel/blog-category') }}">{{ trans('template.common.cancel') }}</a>
													</div>
												</div>
											</div>
										{!! Form::close() !!}
...
<script src="{{ url('resources/pages/scripts/blog_category_validations.js') }}" type="text/javascript"></script>
