                ...
                <div class="login-signup-wrap bg-white rounded shadow">
                    <div class="login-box-header">
                        <div class="login-box-logo mb-5">
                           <a href="{{url('/')}}"> <img alt="logo" src="../assets/images/logo.webp"> </a>
                        </div>
                    ...
                    {!! csrf_field() !!}  
                     ...
                     ?>
                      <input type="hidden" name="previous_url" id="previous_url" value="{{$referurl}}">
                            ...
                            <div class="input-group input-group-merge">
                                <div class="input-icon">
                                 ...
                                 @if(Cookie::get('front_cookie_login_email'))
                                                        <input type="text" name="loginusername" id="loginusername" value="{{Cookie::get('front_cookie_login_email')}}" tabindex="1" class="form-control" placeholder="name@address.com" value="" required="required"  autocomplete=off>
                                                        @else
                                                        ...
                                                        <span class="error">
                                                            {{ $errors->first('loginusername') }}
                                                        </span>
                                                        @endif
                                                       


                                {{-- <inpu t type="email" class="form-control" placeholder="name@address.com" /> --}}
                            </div>
                        </div>
                      ...
                      <div class="input-group-append">
                        ...
                        <input type="checkbox" class="check-remember" tabindex="3" name="remember" id="remember" checked="check">
                            @else
                        ...
                        <div class="captcha-box"> 
                           <div class="form-group">
                                                        <div id="html_element" class="g-recaptcha form-text" data-sitekey="{{ Config::get('Constant.GOOGLE_CAPCHA_KEY') }}" data-callback="check_captchaSignin"></div>
