...
<!-- Gsuite intro section -->
<div class="gsuite-intro head-tb-p-40">
    <div class="container">
        <div class="row">
            <div class="section-heading">
                <h2 class="text_head intro-title">
                    <span>Google Workspace - </span>A Boost to Your Productivity
                </h2>
            </div>
            <div class="col-12 col-sm-8 order-xs-3">
                <div class="left">
                    <div class="title">
                        <p>Your business deserves and demands a better way to promulgate effective collaboration and communication within your team, whether it’s across the continents, cities or rooms. Google Workspace apps are influential yet uncomplicated and apt for any business size - big or small.</p>
                        <p>
                            With Google apps, the businesses are well-equipped to transform the way they work and consolidate their position against their competitors. So, manage your work and store your data online in the all-in-one package of Google Workspace, which can be accessed from any device, i.e., computer, tablet or mobile phone.
                        </p>
                    </div>
                    <?php 
            ...
            <div class="col-12 col-sm-4 order-xs-2">
                <div class="right">
                    <img src="https://www.hostitsmart.com/assets/images/new_icon/g-workspace.webp" alt="Google Workspace Apps">
                </div>
            </div>
            <div class="col-sm-12 order-xs-4">
                <div class="google-apps-case">
                    <div class="title">
                        <p>{{ Config::get('Constant.SITE_NAME') }} offers Google Apps for work</p>
                    </div>
                    <div class="google-apps-slider">
                        <div class="owl-carousel owl-theme">
                            <div class="item g-suits-main">
                                <div class="g-logo g-suits-img">
                                    <img src="https://www.hostitsmart.com/assets/images/new_icon/g-mail.webp" alt="Gmail">
                                    <!-- <i class="g-apps-sprite gmail"></i> -->
                                    <span class="app-name">Gmail</span>
                                </div>
                            </div>
                            <div class="item g-suits-main">
                                <div class="g-logo g-suits-img">
                                    <img src="https://www.hostitsmart.com/assets/images/new_icon/g-calendar.webp" alt="Google Calandar">
                                    <!-- <i class="g-apps-sprite calendar"></i> -->
                                    <span class="app-name">Calendar</span>
                                </div>
                            </div>
                            <div class="item g-suits-main">
                                <div class="g-logo g-suits-img">
                                    <img src="https://www.hostitsmart.com/assets/images/new_icon/g-chat.webp" alt="Google Chat">
                                    <!-- <i class="g-apps-sprite hangouts"></i> -->
                                    <span class="app-name">Chat</span>
                                </div>
                            </div>
                            <div class="item g-suits-main">
                                <div class="g-logo g-suits-img">
                                    <img src="https://www.hostitsmart.com/assets/images/new_icon/g-drive.webp" alt="Google Drive">
                                    <!-- <i class="g-apps-sprite drive"></i> -->
                                    <span class="app-name">Drive</span>
                                </div>
                            </div>
                            <div class="item g-suits-main">
                                <div class="g-logo g-suits-img">
                                    <img src="https://www.hostitsmart.com/assets/images/new_icon/g-docs.webp" alt="Google Docs">
                                    <!-- <i class="g-apps-sprite docs"></i> -->
                                    <span class="app-name">Docs</span>
                                </div>
                            </div>
                            <div class="item g-suits-main">
                                <div class="g-logo g-suits-img">
                                    <img src="https://www.hostitsmart.com/assets/images/new_icon/g-sheets.webp" alt="Google Sheet">
                                    <!-- <i class="g-apps-sprite sheets"></i> -->
                                    <span class="app-name">Sheets</span>
                                </div>
                            </div>
                            <div class="item g-suits-main">
                                <div class="g-logo g-suits-img">
                                    <img src="https://www.hostitsmart.com/assets/images/new_icon/g-forms.webp" alt="Google Forms">
                                    <!-- <i class="g-apps-sprite forms"></i> -->
                                    <span class="app-name">Forms</span>
                                </div>
                            </div>
                            <div class="item g-suits-main">
                                <div class="g-logo g-suits-img">
                                    <img src="https://www.hostitsmart.com/assets/images/new_icon/g-slides.webp" alt="Google Slides">
                                    <!-- <i class="g-apps-sprite slides"></i> -->
                                    <span class="app-name">Slides</span>
                                </div>
                            </div>
                            <div class="item g-suits-main">
                                <div class="g-logo g-suits-img">
                                    <img src="https://www.hostitsmart.com/assets/images/new_icon/g-meet.webp" alt="Google Meet">
                                    <!-- <i class="g-apps-sprite sites"></i> -->
    ...
    <div class="vps-plan-main-div head-tb-p-40 @if($ProductBanner->id == 7) vpsplan_slider_div @endif @if($ProductBanner->id == 4 || $ProductBanner->id == 6 || $ProductBanner->id == 13 || $ProductBanner->id == 8) dedicated-plan-main-div @endif">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12">
                <div class="section-heading">
                <h4 class="text-center text_head">Get More Done at Less Price: Google Workspace Plans and Pricing in India</h4>
                </div>
                </div>
                ...
                <div class="switch-plan" id="switch-plan">
                    ...
                    <label class="switch aos-init" data-aos="zoom-in" data-aos-easing="ease-out-back" data-aos-delay="100">
                        <input type="checkbox" name="monthly" id="monthly" onclick="calc({{$ProductBanner->id}});"> <span class="slider round"></span>
                    </label>
                ...
                @php } if($ProductBanner->id == 21){ @endphp
                    <div class="switch-plan">
                        <div class="month-tab tab-left-save active">New Customer</div>
                        <div class="form-check form-switch">
  <input class="form-check-input" type="checkbox" role="switch"  name="existing" id="existing" onclick="existing_new_filter({{$ProductBanner->id}});"> <span class="slider round"></span>
</div>
                        <!-- <label class="switch">
                            <input type="checkbox" name="existing" id="existing" onclick="existing_new_filter({{$ProductBanner->id}});"> <span class="slider round"></span>
                        </label> -->
                        <div class="month-tab ">Existing Customer</div>
                    </div>
                    <script type="text/javascript">
                    function existing_new_filter(ProductBannerId){
                        if ($('#existing').is(":checked")) {
                            $('#StarterExistingOneYearWhmcsINR').show();
                            $('#StarterOneYearWhmcsINR').hide();
                            $('#StarterOneMonthWhmcsINR').hide();
                            $('#StarterCutprice').hide();
                            $('#StarterMonthlyButtonText').hide();
                            $('#StarterOneYearButtonText').hide();
                            $('#StarterExistingOneYearButtonText').show();
                            $('#PerformCutprice').hide();
                            $('#PerformOneYearWhmcsINR').hide();
                            $('#PerformOneMonthWhmcsINR').hide();
                            $('#PerformExistingOneYearWhmcsINR').show();
                            $('#PerformanceMonthlyButtonText').hide();
                            $('#PerformanceOneYearButtonText').hide();
                            $('#PerformanceExistingOneYearButtonText').show();
                        }else{
                            $('#StarterExistingOneYearWhmcsINR').hide();
                            $('#StarterOneYearWhmcsINR').show();
                            $('#StarterOneMonthWhmcsINR').hide();
                            $('#StarterCutprice').show();
                            $('#StarterMonthlyButtonText').hide();
                            $('#StarterOneYearButtonText').show();
                            $('#StarterExistingOneYearButtonText').hide();
                            $('#PerformCutprice').show();
                            $('#PerformOneYearWhmcsINR').show();
                            $('#PerformOneMonthWhmcsINR').hide();
                            $('#PerformExistingOneYearWhmcsINR').hide();
                            $('#PerformanceMonthlyButtonText').hide();
                            $('#PerformanceOneYearButtonText').show();
                            $('#PerformanceExistingOneYearButtonText').hide();
                        }
                    }
                </script>
                @php } @endphp
                ...
                <script type="text/javascript">
                            function calc(ProductBannerId)
                            {
                                if(ProductBannerId == 21){
                                    $('#switch-plan').hide();
                                }
                                ...
                                <?php /*<div class="col-md-4 col-xs-12 col-12 align-self-center">
                                    <div class="vps-plan-div">
                                        ...
                                        <div class="vps-price-padding">
                                            ...
                                            <a class="more-features" title="More" href="javascript:void(0)" id="StarterOneMonth" onclick="LoadFeatures('StarterOneMonth','{{$StarterOneMonth}}');" style="{{$StarterOneMonth4}}" ><i class="fa-solid fa-plus"></i>More</a>
                                ...
                                <?php /*<div class="col-md-4 col-xs-12 col-12 align-self-center">
                                    <div class="vps-plan-div {{$class}}">
                                        ...
                                        <div class="vps-price-padding">
                                            ...
                                            <a class="more-features" title="More" href="javascript:void(0)" id="PerformOneMonth" onclick="LoadFeatures('PerformOneMonth','{{$PerformOneMonth}}');" style="{{$PerformOneMonth4}}" ><i class="fa-solid fa-plus"></i>More</a>
                                ...
                                <?php /*<div class="col-md-4 col-xs-12 col-12 align-self-center">
                                    <div class="vps-plan-div">
                                        ...
                                        <div class="vps-price-padding">
                                            ...
                                            <a class="more-features" title="More" href="javascript:void(0)" id="BusinessOneMonth" onclick="LoadFeatures('BusinessOneMonth','{{$BusinessOneMonth}}');" style="{{$BusinessOneMonth4}}" ><i class="fa-solid fa-plus"></i>More</a>
                    ...
                    <div id="vps-plan2" class="tab-pane active show">
                        <div class="plan-main-div">
                            <div class="row">
                                    ...
                                    <div class="vps-plan-div">
                                        ...
                                        <div class="vps-price-padding">
                                            <div class="plan-price clearfix">
                                                ...
                                                @php if(Config::get('Constant.sys_currency') == 'INR'){  @endphp
                                                <span class="cut-price-main" id="StarterCutprice"> 
                                                    <span class="dollar-sign">{!! Config::get('Constant.sys_currency_symbol') !!}</span> 
                                                    <span class="cut-price"> {{$ProductsPackageData[0]->intOldPriceOneYearINR}} </span>
                                                </span>
                                                @php } @endphp
                                                ...
                                                <span class="vps-price" id="StarterExistingOneYearWhmcsINR" style="display: none">
                                                    <span class="price-icon">{!! Config::get('Constant.sys_currency_symbol') !!}</span><strong>{{ Config::get('Constant.'.$ProductBanner->varWHMCSPackageFieldName.'_STARTER_EXISTING_PRICE_12_INR') }}</strong>/user/mo*
                                                </span>
                                                @php } else { @endphp 
                                                <span class="vps-price" id="StarterOneMonthWhmcsUSD">
                                                    <span class="price-icon">{!! Config::get('Constant.sys_currency_symbol') !!}</span><strong>{{ Config::get('Constant.'.$ProductBanner->varWHMCSPackageFieldName.'_STARTER_PRICE_1_USD') }}</strong>/user/mo*
                                            ...
                                            <div class="vps-plan-btm" id="StarterExistingOneYearButtonText" style="display: none">
                                                @if(isset($EnterpriseOneYearButtonText) && !empty($EnterpriseOneYearButtonText))
                                                    {{-- {!!$Enterprise1OneYearButtonText!!} --}}
                                    ...
                                    <div class="vps-plan-div {{$class}}">
                                        ...
                                        <div class="vps-price-padding">
                                            <div class="plan-price clearfix">
                                                ...
                                                @php if(Config::get('Constant.sys_currency') == 'INR'){  @endphp
                                                <span class="cut-price-main" id="PerformCutprice"> 
                                                    <span class="dollar-sign">{!! Config::get('Constant.sys_currency_symbol') !!}</span>
                                                    <span class="cut-price"> {{$ProductsPackageData[1]->intOldPriceOneYearINR}} </span>
                                                </span>
                                                @php } @endphp
                                                ...
                                                <span class="vps-price" id="PerformExistingOneYearWhmcsINR" style="display: none">
                                                    <span class="price-icon">{!! Config::get('Constant.sys_currency_symbol') !!}</span><strong>{{ Config::get('Constant.'.$ProductBanner->varWHMCSPackageFieldName.'_PERFORMANCE_EXISTING_PRICE_12_INR') }}</strong>/user/mo*
                                                </span>
                                                @php } else { @endphp 
                                                <span class="vps-price" id="PerformOneMonthWhmcsUSD">
                                                    <span class="price-icon">{!! Config::get('Constant.sys_currency_symbol') !!}</span><strong>{{ Config::get('Constant.'.$ProductBanner->varWHMCSPackageFieldName.'_PERFORMANCE_PRICE_1_USD') }}</strong>/user/mo*
                                            ...
                                            <div class="vps-plan-btm" id="PerformanceExistingOneYearButtonText" style="display: none">
                                                @if(isset($EnterpriseOneYearButtonText) && !empty($EnterpriseOneYearButtonText))
                                                {!!$Enterprise1OneYearButtonText!!}
                                ...
                                @php if($ProductBanner->id == 21) { @endphp
                                <p class="g-suit-cnt">*Offer valid for new Google Workspace users only, covering the first 20 users for 12 months. Afterward, standard pricing applies.</p>
                                @php } @endphp
                                ...
                                <?php /*<div class="col-md-4 col-xs-12 col-12 align-self-center" data-aos="fade-right" data-aos-easing="ease-out-back">
                                    <div class="vps-plan-div">
                                        ...
                                        <div class="vps-price-padding">
                                            ...
                                            <a class="more-features" title="More" href="javascript:void(0)" id="BusinessThreeMonth" onclick="LoadFeatures('BusinessThreeMonth','{{$BusinessThreeMonth}}');" style="{{$BusinessThreeMonth4}}" ><i class="fa-solid fa-plus"></i>More</a>
                                ...
                                <div class="col-md-4 col-xs-12 col-12 align-self-center">
                                    <div class="vps-plan-div">
                                        ...
                                        <div class="vps-price-padding">
                                            ...
                                            <a class="more-features" title="More" href="javascript:void(0)" id="StarterSixMonth" onclick="LoadFeatures('StarterSixMonth','{{$StarterSixMonth}}');" style="{{$StarterSixMonth4}}" ><i class="fa-solid fa-plus"></i>More</a>
                                ...
                                <div class="col-md-4 col-xs-12 col-12 align-self-center">
                                    <div class="vps-plan-div {{$class}}">
                                        ...
                                        <div class="vps-price-padding">
                                            ...
                                            <a class="more-features" title="More" href="javascript:void(0)" id="PerformSixMonth" onclick="LoadFeatures('PerformSixMonth','{{$PerformSixMonth}}');" style="{{$PerformSixMonth4}}" ><i class="fa-solid fa-plus"></i>More</a>
                                ...
                                <div class="col-md-4 col-xs-12 col-12 align-self-center">
                                    <div class="vps-plan-div" >
                                        ...
                                        <div class="vps-price-padding">
                                            ...
                                            <a class="more-features" title="More" href="javascript:void(0)" id="BusinessSixMonth" onclick="LoadFeatures('BusinessSixMonth','{{$BusinessSixMonth}}');" style="{{$BusinessSixMonth4}}" ><i class="fa-solid fa-plus"></i>More</a>
...
@php if($ProductBanner->id == 7) { @endphp
<div class="vps-features vps-plan-features head-tb-p-40" id="StarterOneMonthFeatures" style="display: none">
    <div class="container">
        <div class="row">
            <div class="features-main">
                <h2 class="text_head text-center">Features of Starter</h2>
    ...
    <div class="container">
        <div class="row">
            <div class="features-main">
                ...
                <h2 class="text_head text-center" data-aos="fade-up">Features that bring a 5 star wordpress experience to your plate</h2>
                @php } else if($ProductBanner->id == 7) { @endphp
                <h2 class="text_head text-center" data-aos="fade-up">Features to up your gear</h2>
                @php } else if($ProductBanner->id == 8) { @endphp
                <h2 class="text_head text-center" data-aos="fade-up">Features to make you unstoppable</h2>
                @php } else { @endphp
                                            ...
                                            <div class="feature-box col-xs-12 col-sm-6 col-md-4 d-flex flex-wrap justify-content-center">
                                                <div class="content-main align-self-start">
                                                    <div class="feature-icon">
                                                        <i class="vps-features-icon mail-at-company"></i>
                                                    </div>
                                                    <h3>Get Gmail @yourcompany.com</h3>
                                                    <div class="content">Leave a professional impact on your clients. Set up Gmail for your domain - get storage space, easy migration tools & unlimited groups along with spam-protection and backups.</div>
                                                </div>
                                            </div>
                                            <div class="feature-box col-xs-12 col-sm-6 col-md-4 d-flex flex-wrap justify-content-center">
                                                <div class="content-main align-self-start">
                                                    <div class="feature-icon">
                                                        <i class="vps-features-icon meetings"></i>
                                                    </div>
                                                    <h3>Scheduling Meeting is a Breeze</h3>
                                                    <div class="content">Google Calendar syncs with Gmail, Hangouts, and Drive; and auto-suggests the best times as well as help you keep track of your activities.</div>
                                                </div>
                                            </div>
                                            <div class="feature-box col-xs-12 col-sm-6 col-md-4 d-flex flex-wrap justify-content-center">
                                                <div class="content-main align-self-start">
                                                    <div class="feature-icon">
                                                        <i class="vps-features-icon video-call"></i>
                                                    </div>
                                                    <h3>Communicate, Create & Share in a Jiffy</h3>
                                                    <div class="content">Create files on spreadsheets, documents & others, share them with your team to collaborate in real-time. Use hangouts to video call. Join on-the-go and invite anyone!</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<div class="g-suite-lists head-tb-p-40">
                    <div class="container">
                        <div class="row">
                            <div class="section-heading">
                                <h2 class="text-center text_head">An All-inclusive Suite that Grows Your Business
</h2>
                            </div>
                            <div class="col-sm-6 col-12">
                                <div class="g_s_l-box">
                                    <div class="g-icons atrate"></div>
                                    <div class="g-list-box">
                                        <h4>Email @yourcompany.com</h4>
                                        <span>Level up your professionalism with the power of Gmail in every email.
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-12">
                                <div class="g_s_l-box">
                                    <div class="g-icons storage"></div>
                                    <div class="g-list-box">
                                        <h4>Workspace you need</h4>
                                        <span>Every user receives 30GB of storage space on Google’s Cloud platform which enables collaboration on Google Workspace.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-12">
                                <div class="g_s_l-box">
                                    <div class="g-icons real-time"></div>
                                    <div class="g-list-box">
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="g_s_l-box">
                                    <div class="g-icons work-anywhere"></div>
                                    <div class="g-list-box">
                                        <h4>Work Anytime. Anywhere</h4>
                                        <span>Access your work files saved on the Cloud and transform any place into your office.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-12">
                                <div class="g_s_l-box">
                                    <div class="g-icons migration"></div>
                                    <div class="g-list-box">
                                        <h4>Data migration made easy</h4>
                                        <span>Free tools to migrate your data, like importing emails, quickly and easily.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-12">
                                <div class="g_s_l-box">
                                    <div class="g-icons adv-controls"></div>
                                    <div class="g-list-box">
                                        <h4>Advanced controls</h4>
                                        <span>The central admin panel allows adding/removing users and set up groups and security measures such as 2-step authentication.</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="g-video-section">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6 col-xs-12 g-left">
                                <div class="g_l-content">
                                    <h4 class="title">{{ Config::get('Constant.SITE_NAME') }} is a partner of Google Cloud.</h4>
                                    <span class="desc">So, when you buy Google Workspace from {{ Config::get('Constant.SITE_NAME') }}, you get Google Workspace at the same price as Google and at the same time, {{ Config::get('Constant.SITE_NAME') }} helps you with assisted migration and deployment.</span>
                                    <div class="image">
                                        <img style="border-radius: 10px" src="https://www.hostitsmart.com/assets/images/new_icon/google-workspace-partner.webp" alt="Google Cloud Partner">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-12 g-right">
                                    <div class="g_l-content g_r_content">
                                        <h4 class="title">Get more information about Google Workspace</h4>
                                        <span class="desc">This 3 min video tour will provide an insight of what Google Workspace plans for India has in store for you.</span>
                                        <a class="play-icon" href="#" data-bs-toggle="modal" data-bs-target="#googlepartner">
                    ...
                    <div class="modal fade googlepartner-popup" id="googlepartner" role="dialog">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/vNJUL92y9wo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
...
<script>
 ...
 <script>
     $(".google-apps-case .google-apps-slider .owl-carousel").owlCarousel({autoplay:!0,autoplayTimeout:7e3,autoplayHoverPause:!1,autoplaySpeed:1500,autoplayHoverPause:!0,dots:!1,nav:!0,loop:!0,navText:['<div class="sprite-image pre" title="Previous"></div>','<div class="sprite-image next" title="Next"></div>'],items:9,responsive:{0:{items:3,dots:!0},480:{items:5,dots:!0,nav:!1},767:{items:6,dots:!0,nav:!1},992:{items:9,nav:!0}}});
 </script>
