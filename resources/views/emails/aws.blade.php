                ...
                <td style="padding: 0px 0 0;background: #e6eef6;">
                    <table style="width: 430px;background: #ffffff;margin-bottom: 0px;margin-top: 30px;padding: 19px;border-radius: 2px;margin-bottom: 30px;" align="center" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr><td style="font-size: 15px;font-weight: 600;font-family: 'Segoe UI', 'Apple SD Gothic Neo', 'Lucida Grande', 'Lucida Sans Unicode', 'sans-serif';text-align: center;padding-bottom: 14px;max-width: 150px;color: #333;letter-spacing: .5px;">A new person has contacted us, below are the details of that person:</td></tr>
                            @if($user=='admin')
                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="font-family: 'Segoe UI', 'Apple SD Gothic Neo', 'Lucida Grande', 'Lucida Sans Unicode', 'sans-serif';padding-bottom: 7px;padding-top: 12px;">
                                                    ...
                                                    <img src="{{url('assets/images/email-images/bullet.png')}}" width="11" alt="" style="margin-right: 6px;opacity: 0.7;">First Name :</b>{{$var_Fname}}
                                                </td>
                                            </tr>
                                             <tr>
                                                <td style="font-family: 'Segoe UI', 'Apple SD Gothic Neo', 'Lucida Grande', 'Lucida Sans Unicode', 'sans-serif';padding-bottom: 7px;padding-top: 12px;">
                                                    <b style="margin-right: 5px;color: #555;">
                                                    <img src="{{url('assets/images/email-images/bullet.png')}}" width="11" alt="" style="margin-right: 6px;opacity: 0.7;">Last Name :</b>{{$var_Lname}}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-family: 'Segoe UI', 'Apple SD Gothic Neo', 'Lucida Grande', 'Lucida Sans Unicode', 'sans-serif';padding-bottom: 7px;">
                                                    <b style="margin-right: 5px;color: #555;">
                                                    <img src="{{url('assets/images/email-images/bullet.png')}}" width="11" alt="" style="margin-right: 6px;opacity: 0.7;">Email Id :</b><a href="mailto:{{$var_email}}" style="color: #115ba9;">{{$var_email}}</a>
                                                </td>
                                            </tr>
                                            @if(isset($var_phone) && !empty($var_phone))
                                            <tr>
                                                <td style="font-family: 'Segoe UI', 'Apple SD Gothic Neo', 'Lucida Grande', 'Lucida Sans Unicode', 'sans-serif';padding-bottom: 7px;">
                                                    <b style="margin-right: 5px;color: #555;">
                                                    <img src="{{url('assets/images/email-images/bullet.png')}}" width="11" alt="" style="margin-right: 6px;opacity: 0.7;">Phone # :</b>{{$var_phone}}
                                                </td>
                                            </tr>
                                            @endif
                                            @if(isset($var_company) && !empty($var_company))
                                            <tr>
                                                <td style="font-family: 'Segoe UI', 'Apple SD Gothic Neo', 'Lucida Grande', 'Lucida Sans Unicode', 'sans-serif';padding-bottom: 7px;">
                                                    <b style="margin-right: 5px;color: #555;">
                                                    <img src="{{url('assets/images/email-images/bullet.png')}}" width="11" alt="" style="margin-right: 6px;opacity: 0.7;">Company:</b>{{$var_company}}
                                                </td>
                                            </tr>
                                            @endif
                                            @if(isset($var_state) && !empty($var_state))
                                            <tr>
                                                <td style="font-family: 'Segoe UI', 'Apple SD Gothic Neo', 'Lucida Grande', 'Lucida Sans Unicode', 'sans-serif';padding-bottom: 7px;">
                                                    <b style="margin-right: 5px;color: #555;">
                                                    <img src="{{url('assets/images/email-images/bullet.png')}}" width="11" alt="" style="margin-right: 6px;opacity: 0.7;">State :</b>{{$var_state}}
                                                </td>
                                            </tr>
                                            @endif
                                            @if(isset($var_message) && !empty($var_message))
                                            <tr><td style="font-family: 'Segoe UI', 'Apple SD Gothic Neo', 'Lucida Grande', 'Lucida Sans Unicode', 'sans-serif';padding-bottom: 7px;">
                                                    <b style="margin-right: 5px;color: #555;">
                                                    <img src="{{url('assets/images/email-images/bullet.png')}}" width="11" alt="" style="margin-right: 6px;opacity: 0.7;">Message :</b>{{$var_message}}
                                                </td>
                                            </tr>
                                            @endif
                                        </tbody>
