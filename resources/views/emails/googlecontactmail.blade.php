                ...
                <td style="padding: 0px 0 0;background: #e6eef6;">
                    <table style="width: 430px;background: #ffffff;margin-bottom: 0px;margin-top: 30px;padding: 19px;border-radius: 2px;margin-bottom: 30px;" align="center" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            @else
                            <tr><td style="font-size: 18px;font-weight: 700;font-family: 'Segoe UI', 'Apple SD Gothic Neo', 'Lucida Grande', 'Lucida Sans Unicode', 'sans-serif';text-align: center;padding-bottom: 8px;max-width: 150px;color: #333;letter-spacing: 1px;">Hello {{ $first_name }},</td></tr>
                            <tr><td style="font-size: 15px;font-weight: 600;font-family: 'Segoe UI', 'Apple SD Gothic Neo', 'Lucida Grande', 'Lucida Sans Unicode', 'sans-serif';text-align: center;padding-bottom: 14px;max-width: 150px;color: #333;letter-spacing: .5px;">Thank you for filling out the form for Google Workspace with Host IT Smart! We appreciate your interest in our services.</td>
                            <tr><td style="font-size: 15px;font-weight: 600;font-family: 'Segoe UI', 'Apple SD Gothic Neo', 'Lucida Grande', 'Lucida Sans Unicode', 'sans-serif';text-align: center;padding-bottom: 14px;max-width: 150px;color: #333;letter-spacing: .5px;">Our team is currently reviewing your request and will reach out to you shortly to assist you further!</td>
                            </tr>
                            @endif
                            @if($user=='admin')
                            <tr>
                                    ...
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="font-family: 'Segoe UI', 'Apple SD Gothic Neo', 'Lucida Grande', 'Lucida Sans Unicode', 'sans-serif';padding-bottom: 7px;">
                                                    <b style="margin-right: 5px;color: #555;">
                                                    <img src="{{url('assets/images/email-images/bullet.png')}}" width="11" alt="" style="margin-right: 6px;opacity: 0.7;">Domain # :</b>{{$domain}}
                                                </td>
                                            </tr>
                                            @endif

                                            @if(isset($licenses_no) && !empty($licenses_no))
                                            <tr>
                                                <td style="font-family: 'Segoe UI', 'Apple SD Gothic Neo', 'Lucida Grande', 'Lucida Sans Unicode', 'sans-serif';padding-bottom: 7px;">
                                                    <b style="margin-right: 5px;color: #555;">
                                                    <img src="{{url('assets/images/email-images/bullet.png')}}" width="11" alt="" style="margin-right: 6px;opacity: 0.7;">Licenses No. # :</b>{{$licenses_no}}
                                                </td>
                                            </tr>
                                            @endif
